			...
			<div class="content">
                    ...
                    <div class="container">
                     ...
                     <div class="panel-heading">
                                 	...
                                 	<div class="row">
                                   <form:form action="searchDispatch"  modelAttribute="dispatchDTO" class="form-inline">		
                        		<div class="panel-heading">
                        		
                        		
<div class="form-group">
	 <label class="" for="email">From:</label>
<form:input type="text" path="createdBy" value="${fromdate}" id="datepicker-autoclose" class="form-control input-sm"  />
</div>

<div class="form-group">
	 <label class="" for="email">To:</label>
<form:input type="text" path="dispatchDate" value="${toDate}" id="datepicker-autoclose1"  class="form-control input-sm"  />
</div>

<div class="form-group">
	 <label class="" for="email">Delivery Status:</label>
<form:select path="dispatchStatus" title="----Delivery status----"  id="assign" class="form-control input-sm">
																<form:option value="" label="select Application status" ></form:option>
																<form:option path="dispatchStatus" value="InTransit">InTransit</form:option>
																<form:option path="dispatchStatus" value="Received">Received</form:option>
																<form:option path="dispatchStatus" value="RTO">RTO</form:option>
																	<form:option path="dispatchStatus" value="InProgress">InProgress</form:option>
																</form:select>
</div>
 ...
 <table id="example" class="grid display nowrap" style="width: 100%">
                                        <thead>
                                          ...
                                          <!--  <th class="filterid">Dispatch Id</th> -->
                                            ...
                                            <tr>
                                          <!--  <th class="filterid">Dispatch Id</th> -->
                                                <th class="filtername">Application No</th>
                                               <th class="filtername1">Customer Name</th>
                                                <th class="filtername2">Product Name</th>
                                               <th class="filtername3">Dispatch Date</th>
                                              <th class="filtername4">Dispatch Through</th>
                                               <th class="filtername5">Consignment Reference</th>
                                               <th class="filtername6">Card No</th>
                                               <th class="filtername7">Delivery Status</th>
                                                    <th>Action</th>
                                            </tr>
                                        </tfoot>

														 <tbody>
                                            <c:forEach items="${dispatchTrack}" var="dispatch">
                        <tr>
                        	<%-- <td class="account-id"><a class="sort-value" href="user/1" target="_blank"><c:out value="${dispatch.trackId}"/></a></td> --%>
                        	<td class="account-name sort-value"><c:out value="${dispatch.applicationNo}"/></td> 
                        	<td class="account-name1 sort-value"><c:out value="${dispatch.customerName}"/></td>
                        	 <td class="account-name2 sort-value"><c:out value="${dispatch.createdBy}"/></td>
                       		 <td class="account-name3 sort-value"><c:out value="${dispatch.dispatchDate}"/></td>
                        	<td class="account-name4 sort-value"><c:out value="${dispatch.dispatchThrough}"/></td>
                        	<td class="account-name5 sort-value"><c:out value="${dispatch.consignmentReference}"/></td> 
                        	<td class="account-name6 sort-value"><c:out value="${dispatch.cardNumber}"/></td> 
                        	<td class="account-name7 sort-value"><c:out value="${dispatch.deliveryStatus}"/></td> 
                        	<td>
                        	<c:if test="${dispatch.deliveryStatus ne 'RTO'}">
                        	<a href="viewDispatchDetails?trackId=<c:out value='${dispatch.trackId}'/>"><i class="fa fa-eye" aria-hidden="true"></i></a>
                        	<c:if test="${dispatch.dispatchDate == null}">
                      	 <a href="editDispatch?trackId=<c:out value='${dispatch.trackId}'/>"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
                       </c:if>
                       </c:if>
                       </td>
                        </tr>
