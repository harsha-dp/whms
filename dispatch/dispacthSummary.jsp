			...
			<div class="navbar navbar-default" role="navigation">
				<div class="container">
					...
					<ul class="nav navbar-nav navbar-left">
						...
						<li class="hidden-xs hidden-sm"><font class="page-title">DISPATCH SUMMARY</font></li>
					</ul>
					...
					<div id="myDIV">
						<div class="panel panel-default">
							<div class="panel-heading">
								<form action="dispatchSummary1" method="post">
											...
											<div class="form-group">
												<div class="col-sm-10">
													<div class="input-daterange input-group" >
														...
														<input type="text" name="fromDate" value="${fromDate}" id="datepicker-autoclose"
														...
														<input type="text" name="toDate" value="${toDate}"
															id="datepicker-autoclose1" class="form-control input-sm" /> <span
															class="input-group-addon bg-default b-0 text-black">Status
															</span>
									...
									<div class="row">
										<div class="col-sm-12">
                                       	...
                                       	<%--  <c:out value="${columnName.size()}"></c:out> --%>
                                            ...
                                            <td align="center"><b>${name.columnName}</b></td>
									</c:forEach>
                                   </tr>
                                        </thead>
                                        <tfoot>
