...
<!--  // interger validation script -->
 <!--add file validation  -->
<script src="resources/validation/dispatch/vouchersearch.js"></script>
<!--  -->
</head>
				...
				<div class="container">
					...
					<ul class="nav navbar-nav navbar-left">
						...
						<li class="hidden-xs hidden-sm"	>
							<font face="verdana" class="page-title">SEARCH VOUCHERS</font>
				...
				<div class="container">
					...
					<div class="row">
						<div class="col-sm-12">
				            	...
				            	<form action="searchVoucher" name="form1" onsubmit="return validate1()">
				                <div class="input-group col-md-12">
				                    <input type="text" class="form-control input-sm" name="voucherNo" id="search" placeholder="Enter Vocher Number" />
				                ...
				                <font id="seracherror" style="color:red"></font>
				                </form>
					        </div>
					        </div>
					...
					<tbody>
					  ...
					  <c:forEach var="row" items="${stkList}"> 
                                <tr>
                                   ...
                                   <c:if test="${columnName.size() >= 2}"><td><a href="editTransaction?transactionId=<c:out value='${row.attr1}'/>" >${row.attr2}</a></td></c:if>
