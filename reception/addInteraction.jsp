...
<script src="resources/validation/reception/addInteraction.js"></script>
<!--  -->
<style>
				...
				<div class="container" style="height: 70px">
					...
					<ul class="nav navbar-nav navbar-left">
					 <li>
						...
						<li class="hidden-xs hidden-sm"><font face="verdana" class="page-title">ADD INTERACTION </font></li>
					</ul>
							...
							<!-- <div class="modal-dialog">
								<div class="modal-content"> -->
									...
									<div class="custom-modal-text text-left">
										<form:form action="saveInterAction" name="form" onsubmit="return validate()"
											modelAttribute="interActionTO">
										...
										<div class="col-lg-6">	
											<div class="form-group">
												<label for="name">Cumstomer Name <span style="color:red;">*</span></label>
												<form:input type="text" path="" class="form-control"
													value="${registerTO.details}" 
											...
											<div class="form-group">
												...
												<form:input type="text" path=""
													value="${registerTO.purpose}" class="form-control" 
													id="Contactnumber"  readonly="true"/>
											...
											<%-- 	<form:option value="" label="Select Mode Of Interaction" /> --%>
												<c:forEach var="mode" varStatus="status" items="${welezoConstant}">
												<c:if test="${mode.constType=='Interaction Mode'}">
												<form:option path="interactionMode" value="${mode.CValue}" >${mode.CDisplay}</form:option>
												</c:if>
											</c:forEach>
										</form:select>
...
<div class="col-lg-6">	
											<div class="form-group">
												...
												<form:select path="purpose" class="form-control" id="purposeee">
												   <form:option value="" label="Select Purpose" />
												<c:forEach var="mode" varStatus="status" items="${welezoConstant}">
												<c:if test="${mode.constType=='Purpose'}">
											...
											<div class="form-group">
												...
												<form:select path="interactionThru" class="form-control" id="through">
													 <form:option value="" label="Select Interaction Through" />
												<c:forEach var="mode" varStatus="status" items="${welezoConstant}">
												<c:if test="${mode.constType=='Interaction Through'}">
												<form:option path="purpose" value="${mode.CValue}" >${mode.CDisplay}</form:option>
												</c:if>
											</c:forEach>
												</form:select>
											...
											<div class="form-group">
												...
												<form:textarea type="text" path="details" class="form-control"
													id="details1" placeholder="Enter Details" />
													<font id="detilserror" style="color: red;"></font>
											</div>
											<%-- <div class="form-group">
												<label for="exampleInputEmail1">Remarks :</label>
												<form:textarea path="remarks" type="text" class="form-control"
													id="exampleInputEmail1" placeholder="Enter Note" />
											</div> --%>
											<!-- <div class="form-group">
