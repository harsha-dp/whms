            ...
            <div class="container">
                    ...
                    <div class="col-sm-12">
                        <div class="card-box table-responsive">
                            <h4 class="header-title m-t-0 m-b-30">EMPLOYEE LEAVES LIST</h4>
                            <div class="row">
                                 			<div class="col-md-12" >
                                 			<div class="form-group">
                            <form action="viewLeaves1" >
			                                			<div class="col-sm-8">
                     ...
                     <!--        <h4 class="header-title m-t-0 m-b-30">EMPLOYEE LEAVE LIST</h4> -->
                            ...
                            <table id="datatable-buttons" class="table table-striped table-bordered">
                                ...
                                <tbody>
                                         <c:forEach items="${allLeaves}" var="leave" varStatus="counter">
                        <tr>
                            <td><c:out value="${counter.index + 1}" /></td>
                        	<td class="account-name sort-value"><a href="editleaves?requestId=<c:out value='${leave.requestId}'/>">
                        	<c:out value="${leave.empName}"/></a></td>
                        	<td class="account-name1 sort-value"><c:out value="${leave.fromDate}"/></td>
                       		<td class="account-name2 sort-value"><c:out value="${leave.toDate}"/></td>
                        	<td class="account-name3 sort-value"><c:out value="${leave.totalDays}"/></td> 
                        	<td class="account-name4 sort-value"><c:out value="${leave.status}"/></td>
                        	<td class="account-name5 sort-value"><c:out value="${leave.leaveType}"/></td>
                        </tr>
                    </c:forEach>
                                </tbody>
                            </table>
