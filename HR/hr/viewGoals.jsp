            ...
            <div class="container">
                    ...
                    <div class="col-sm-12">
                        <div class="card-box table-responsive">
                            ...
                            <h4 class="header-title m-t-0 m-b-30">EMPLOYEE GOALS LIST</h4>
                           
 <div class="row">
                                 			<div class="col-md-12" >
                                 			<div class="form-group">
                            <form action="viewAllGoal" >
			                                			<div class="col-sm-8">
			                                				<div class="input-daterange input-group" id="date-range">
			                                					<span class="input-group-addon bg-primary b-0 text-white">Plan Date Between</span>
																<input type="text" id="datepickerautoclose" name="fromDate" value="${fromDate}" class="form-control input-sm"  />
																<span class="input-group-addon bg-primary b-0 text-white">To</span>
																<input type="text" name="toDate" value="${toDate}" id="date-range" class="form-control input-sm"  />
																<span class="input-group-addon bg-primary b-0 text-white">Status</span>
                        ...
                        <tr>
                        	...
                        	<td class="account-name sort-value"><a href="editGoal?goalId=<c:out value='${goal.goalId}'/>"><c:out value="${goal.goalName}"/></a></td>
