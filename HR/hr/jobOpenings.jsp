...
function validate(from)
{
    ...
    var openings=form["openings"].value;
     ...
     var daterange=form["daterange"].value;
     error.innerHTML="";
					...
					<div class="row">
						<!--Custom Toolbar-->
							...
							<!-- <div class="card-box card-outline-danger"> -->
                                ...
                                <tbody>
                                    <c:forEach items="${allJobOpenings}" var="jobList" varStatus="counter">
                        <tr>
                        	...
                        	<td class="account-name4 sort-value"><c:out value="${jobList.filledPosition}"/></td>
                        		<td><a href="editJobOpenings?jobOpenId=<c:out value='${jobList.jobOpenId}'/>">UPDATE</a></td>
                        </tr>
                    </c:forEach>
                                </tbody>
                            </table>
								...
								<hr>
													 <form:form action="saveOpenings" name="form" onsubmit="return validate()" modelAttribute="jobOpenTO">
													 <form:hidden path="filledPosition" value="0"/>
								                <div class="col-sm-12">
								                <div class="col-md-12">
								                    <div class="form-group row">
													  <label for="example-email-input" class="col-2 col-form-label">No of openings <span style="color:red">*</span></label>
													  <div class="col-10">
													    <form:input  type="number" path="noPosition" id="openings" class="form-control" />
                                         ...
                                         <form:option value="" label="Select(Designation(Grade-BU-Dept.-Section)) " />
                                       <c:forEach items="${allRoles}" var="role" varStatus="status">
											<form:option path="roleId" value="${role.roleId}" >${role.designation}</form:option>		
                                      </c:forEach>
                                       </form:select> 
								...
								<c:forEach items="${allRoles}" var="role" varStatus="status">
                                         ...
                                         <form:hidden path="roleId" id="answerInput-hidden" />
						<script type="text/javascript">
						        ...
						        if(option.innerText === inputValue) {
						            ...
						            break;
													...
													<div class="input-group">
														<form:input type="text" path="openDate" class="form-control" 
															placeholder="dd/mm/yyyy" id="daterange"/> <span
