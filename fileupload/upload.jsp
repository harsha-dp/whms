    ...
    <body class="fixed-left">
                    ...
                    <div class="container">
                        ...
                        <ul class="nav navbar-nav navbar-left">
                           <li>
                            ...
                            <li>
                            <font face="verdana" color="#d3dd26" class="page-title"><u>UPLOAD FILES :</u></font>
       ...
       <form method="post" action="doUpload" enctype="multipart/form-data">
        ...
        <div class="panel panel-default">
            ...
            <p><img   src="${bufferedImage[1]}"></p>
            <c:forEach var="documentList" varStatus="status" items="${documentList}">
												<p>	${documentList}</p>
												<%-- <p><img path="${documentList}"  src="resources\images\view.png"> --%>
											<%-- 	<img   src="data:image/png;base64,${documentList}" width="100px" height="100px"> --%>
                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                    <c:forEach items="${allFiles}" var="doc" varStatus="counter">
                        <tr>
                            <td>${doc.uploadId}</td>
                            <td><img   src="data:image/png;base64,${doc.fileName}" width="100px" height="100px"></td>
                            <td><a href="<c:url value='/download-document-${doc.uploadId}' />" class="btn btn-success custom-width">download</a></td>
                            <td><a href="<c:url value='/delete-document-${doc.uploadId}' />" class="btn btn-danger custom-width">delete</a></td>
                        </tr>
                    </c:forEach>
                    </tbody>
                </table>
