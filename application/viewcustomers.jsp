...
<meta name="description" content="A fully CRM">
				...
				<div class="container">
					...
					<ul class="nav navbar-nav navbar-left">
						...
						<li class="hidden-xs hidden-sm"><font face="verdana"
							class="page-title">VIEW CUSTOMERS</font> <!--  <h4 class="page-title">Viewcustomers</h4> -->
						</li>
					</ul>
				...
				<br>
					<div class="card-box table-responsive">
						...
						<div class="col-sm-1.5">
							<div class="m-b-15">
								<a href="addcustomers"><button type="button"
										class="btn btn-purple btn-rounded w-md waves-effect waves-light m-b-20">Add
						...
						<table id="example" class="display nowrap" width="100%">
							...
							<tbody>
								<c:forEach items="${custDetails}" var="cust" varStatus="counter">
									<tr>
										...
										<td><c:out value="${cust.maritalStatus}" /></td>

										<th><a
											href="custEdit?customerId=<c:out value='${cust.customerId}'/>"><i
												class="fa fa-pencil-square-o" aria-hidden="true"></i></a> <%-- <a href="custDelete?customerId=<c:out value='${cust.customerId}'/>"><i class="fa fa-trash-o" aria-hidden="true"></i></a> --%>
										</th>
									</tr>
								</c:forEach>
							</tbody>
