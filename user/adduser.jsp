...
<ul class="nav navbar-nav navbar-right">
                        		...
                        		<div class="text-center card-box">
                                    <div class="dropdown pull-right">
                                        ...
                                        <ul class="dropdown-menu" role="menu">
                                            <li><a href="#custom-modal" class="btn btn-success btn-md waves-effect waves-light m-b-30" data-animation="fadein" data-plugin="custommodal"
                                                    	data-overlaySpeed="200" >Edit</a></li>
                                    ...
                                    <div>
                                        <div class="text-left">
                                            <p class="text-muted font-13"><strong>Name :</strong> <span class="m-l-15"><c:out value="${user.userName}"/></span></p>

                                            <p class="text-muted font-13"><strong>Email Id :</strong><span class="m-l-15"><c:out value="${user.userMail}"/></span></p>

                                            <p class="text-muted font-13"><strong>User Type :</strong> <span class="m-l-15"><c:out value="${user.roleType}"/></span></p>

                                            <p class="text-muted font-13"><strong>Last Login Time :</strong> <span class="m-l-15"><c:out value="${user.mobileNumber}"/></span></p>
                                        </div>
			...
			<div id="custom-modal" class="modal-demo">
			    ...
			    <div class="custom-modal-text text-left">
			       <form:form role="form" action="saveUsers" modelAttribute="usermasterDTO">
			        	<div class="form-group">
                            <label for="name">User Name</label>
                            <form:input path="userName" type="text" class="form-control" id="name" placeholder="Enter name" />
                        </div>
                        <div class="form-group">
                            <label for="name">Email Id</label>
                            <form:input path="userMail" type="text" class="form-control" id="name" placeholder="Enter Email Id" />
                        </div>
                         <div class="form-group">
                            <label for="name">Mobile Number</label>
                            <form:input path="mobileNumber" type="text" class="form-control" id="name" placeholder="Enter Email Id" />
                        </div>
                        <div class="form-group">
                            <label for="name">User Login Name</label>
                            <form:input path="userLoginName" type="text" class="form-control" id="name" placeholder="User Login Name" />
                        </div>
                        <div class="form-group">
                            <label for="company" >Password</label>
                           <form:input path="password"   class="form-control" id="company" placeholder="Password" />
                        </div>
                        <div class="form-group">
                           <form:label path="createdBy" for="company">Created By</form:label>
                            <form:input path="createdBy" type="text" value="${userLogin.userName}" class="form-control" id="company" placeholder="Enter Created By" />
                        </div>
                       <%--  <div class="form-group">
                            <label for="company">Mobile Number</label>
                       <form:input path="" type="text"  class="form-control" placeholder="dd/mm/yyyy" id="datepicker-autoclose" />
