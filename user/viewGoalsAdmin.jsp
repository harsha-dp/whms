...
<!--add file validation  -->
<script src="resources/validation/user/viewGoalsAdmin.js"></script>
<!--  -->
    </head>
                        ...
                        <li>
                            ...
                            <li class="hidden-xs hidden-sm">
                             <!--    <h4 class="page-title">View Hospitals </h4> -->
                                <font face="verdana"  class="page-title">VIEW GOALS LIST</font>
                            </li>
                        </ul>
                              ...
                              <%--   <div class="col-sm-12">
                                       ...
                                       <div class="form-group">
			                                 <div class="input-daterange input-group" id="date-range">
		                                      <span class="input-group-addon bg-warning !important; b-0 text-white">Date</span>
							         <input type="text" name="">
                                        ...
                                        <div class="col-sm-2">
			                                			<div class="input-daterange input-group" id="date-range">
													    <button type="submit" class="btn btn-primary btn-rounded btn-sm waves-effect waves-light" value="Go"><i class="fa fa-search" aria-hidden="true"></i> Search</button>
			                                </div>
			                            </div>
                                        </div>
                                        </form>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <div align="left">
													...
													<a href="goalSettingCSR?userId=<c:out value="${USERID}" />"
														class="btn btn-success btn-md waves-effect waves-light"
														data-overlaySpeed="200" data-overlayColor="#36404a">SET GOALS CSR	</a>
														<a href="goalSettingExecutive?userId=<c:out value="${USERID}" />"
														class="btn btn-success btn-md waves-effect waves-light"
														data-overlaySpeed="200" data-overlayColor="#36404a">SET GOALS EXECUTIVES	</a>
														<a href="goalSettingOthers?userId=<c:out value="${USERID}" />"
														class="btn btn-success btn-md waves-effect waves-light"
														data-overlaySpeed="200" data-overlayColor="#36404a">SET GOALS</a>
										</div>
										<br/>
                                    <div class="scrollit">
 <table id="example" class="grid display nowrap" style="width: 100%">
                        ...
                        <tr>
                        	...
                        	<td class="account-name6 sort-value"><c:out value="${goal.target}"/></td>
...
<script src="resources/js/jquery.fott.js"></script>
<script>
		$('.filterid').fott({fieldFilter: 'account-id'});
		$('.filtername').fott({fieldFilter: 'account-name'});
		$('.filtername1').fott({fieldFilter: 'account-name1'});
		$('.filtername2').fott({fieldFilter: 'account-name2'});
		$('.filtername3').fott({fieldFilter: 'account-name3'});
		$('.filtername4').fott({fieldFilter: 'account-name4'});
		$('.filtername5').fott({fieldFilter: 'account-name5'});
		$('.filtername6').fott({fieldFilter: 'account-name6'});
		$('.filtername7').fott({fieldFilter: 'account-name7'});
</script> -->
