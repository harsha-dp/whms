			...
			<div class="navbar navbar-default" role="navigation">
				<div class="container">
					...
					<ul class="nav navbar-nav navbar-left">
						...
						<li class="hidden-xs hidden-sm"><font class="page-title">CALLS
								STATUS UPDATE</font></li>
					</ul>
					...
					<div id="myDIV">
						<div class="panel panel-default">
							<div class="panel-heading">
								...
								<div class="row">
									<form action="updateCallStatus1" method="post" class="form-inline">
										<div class="panel-heading">
										
										<div class="form-group">
	 <label class="" for="email">From:</label>
<input type="text" name="date" value="${fromDate}"
															id="datepicker-autoclose" class="form-control input-sm" />
</div>

<div class="form-group">
	 <label class="" for="email">CSR:</label>
<select name="csr" title="----Csr Name----"
															class="form-control input-sm">
															<option value="${employeeId.empId}">${employeeId.empName}</option>
	 ...
	 <button type="submit"
							...
							<div id="myDIV">
								<div class="panel-body">
									<div class="row">
										<div class="col-sm-12">
											<form action="saveCallStatus" method="post">
												<input type="hidden" name="empId"
													value="${employeeId.empId}"> <input type="hidden"
													...
													<div class="col-md-12 col-sm-12">
														<div class="card-box table-responsive">
															...
															<div style="height: 400px; overflow: auto;">
																...
																<h5>
																	CSE Name: ${employeeId.empName} &nbsp; &nbsp; &nbsp;
																	&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
																	&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
																	&nbsp; Called Date: ${fromDate}, &nbsp; &nbsp; &nbsp;
																	&nbsp; &nbsp; Search phone number :<i
																		class="fa fa-arrow-right" aria-hidden="true"></i><input
																		type="number" class="light-table-filter"
																			...
																			<c:forEach items="${phoneList}" var="list"
																				...
																				<tr style="display: table-row;">
																					...
																					<td><input type="hidden" name="id"
																						value="${list.id}">
																					<c:out value="${counter.index + 1}" /></td>
																					<td><input type="hidden" name="phoneNo"
																						value="${list.phoneNo}">
																					<c:out value="${list.phoneNo}" /></td>
																					<td><c:out value="${list.calltime}" /></td>
																					<td><c:out value="${list.duration}" /></td>
																					<td><select name="status" class="state"
																						id="state">
																							<option label="Select Status"></option>
																							<c:forEach items="${welezoConstant}" var="list">
																								<c:if test="${list.constType == 'Call_status'}">
																									<option value="${list.CValue}">${list.CDisplay}</option>
																								</c:if>
																							</c:forEach>
																					</select></td>
																					<!-- <td>
								<select name="status" class="state" id="state">
								 <option label="Select Status" ></option>
													 <option  value="NotInterested">NotInterested</option>
													<option value="NotListening">Not Listening</option>
													<option value="CannotSell">Cannot Sell</option>
													...
													<option  value="Sale Done" >Sale Done</option>
																					...
																					<td><select name="reasons">
																							<option label="Select Status"></option>
																							<c:forEach items="${welezoConstant}" var="list">
																								<c:if test="${list.constType == 'Call_Reason'}">
																									<option value="${list.CValue}">${list.CDisplay}</option>

																								</c:if>
																							</c:forEach>
																					</select><br /> <input type="date" name="nextDate"
																						class="text province" id="province" /></td>
																					<!-- <script>
var $state = $('.state');

$state.change(function() { $province=$(this).closest("tr").find("td").children("input[type=text]");
    ...
    { $province.removeAttr('disabled');
        ...
        $province.attr('disabled', 'disabled').val('');
																					...
																					<td><textarea name="remarks" cols="30"
																							rows="2"></textarea></td>
																				</tr>
																			</c:forEach>
