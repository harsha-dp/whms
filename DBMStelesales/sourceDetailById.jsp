...
<link rel="stylesheet" href="http://netdna.bootstrapcdn.com/bootstrap/3.1.1/css/bootstrap.min.css">
 ...
 <!--add file validation  -->
<script src="resources/validation/DBMStelesales/sourceDetailById.js"></script>
<!--  -->        
         </head>
                    ...
                    <div class="container">
                        ...
                        <ul class="nav navbar-nav navbar-left">
                          <li>
                            ...
                            <font class="page-title">DATABASE DETAILS</font>
                            </li>
                        </ul>
				...
				<div class="row">
                            ...
                            <h5>DATABASE DETAILS</h5>
                                  ...
                                  <table style="width: 100%">
								    	...
								    	<tr>
								    	<td><font color="blue">Data Provided By <i class="fa fa-hand-o-right" aria-hidden="true"></i></font></td>
										<td><h4 class="text-success">${sourceDetails.providedBy}</h4></td>
										
										<td><font color="blue">Data Quantity <i class="fa fa-hand-o-right" aria-hidden="true"></i></font></td>
										<td><h4 class="text-success">${sourceDetails.dataQuantity}</h4></td>
									</tr>
									<tr>
										<td><font color="blue">Source Details <i class="fa fa-hand-o-right" aria-hidden="true"></i></font></td>
										<td><h4 class="text-success">${sourceDetails.sourceDetails}</h4></td>
										<td><font color="blue">Data Upload Date <i class="fa fa-hand-o-right" aria-hidden="true"></i></font></td>
										<td><h4 class="text-success">${sourceDetails.uploadDate}</h4></td>
									</tr>
           ...
           <table id="datatable-button" class="table table-striped table-bordered">
            ...
            <tr>
             ...
             <tbody>
                        ...
                        <%-- 	<td><c:out value="${list.sourceId}" /></td> --%>
                        	<td><c:out value="${list.leadStatus}" /></td>
                        	
                        	
                                <td><c:out value="${list.Total}"/>
                            ...
                            <div class="col-sm-6">
                            <div class="card-box">
                              <h5>DATABASE ALLOCATION INFORMATION</h5>
           <table id="datatable-buttons" class="table table-striped table-bordered">
            ...
            <tr>
											        ...
											        <th>Allocated Date</th>
                                              		<th>CSR NAME</th>
                                             		<th>TOTAL ALLOCATED NO.</th>
                                            </tr>
            </thead>
             <tbody>
                                 <c:forEach items="${allAllocatedData}" var="list" varStatus="counter">
                        <tr>
                       		 <td><c:out value="${counter.index + 1}" /></td>
                   			<td><c:out value="${list.allocatedDate}" /></td>
                        	<td><c:out value="${list.empName}" /></td>
                       		<td><c:out value="${list.Allocated}"/></td>
                        </tr>
                    </c:forEach>
                                        </tbody>
