                        ...
                        <ul class="nav navbar-nav navbar-left">
                         <li>
                            ...
                            <li class="hidden-xs hidden-sm"	>
                                <font class="page-title">DATA ALLOCATION</font>
                            </li>
                        </ul>
			...
			<div class="content">
                    ...
                    <div class="container">
                     ...
                     <div class="panel-heading">
                                 	...
                                 	<div class="row">
                                    <form action="viewAllocation1" method="post" class="form-inline">		
                        		<div class="panel-heading">
                        		<div class="col-sm-12">
                        		<div class="form-group">
	 <label class="" for="email">From:</label>
<input type="text" name="date" value="${fromDate}" id="datepicker-autoclose" class="form-control input-sm"  />
</div>	 
<div class="form-group">
	 <label class="" for="email">CSR List:</label>
...
<div class="form-group">
	<button type="submit" class="btn btn-default btn-rounded btn-sm waves-effect waves-light" value="Go"><i class="fa fa-search" aria-hidden="true"></i> Search</button>
	                    ...
	                    <div class="row">
                            <div class="col-sm-12">
                                     <div class="scrollit">
 <table id="example" class="grid display nowrap" cellspacing="0" width="100%">
  <title><h5>CSE Name: ${employeeId.empName}  &nbsp; Allocated Date: ${fromDate}&nbsp; Source Details:${sourceDetailsById.sourceDetails}</h5></title> 
                                       <thead>
                                       	<tr>
                                       	<td><b>SL NO</b></td>
                                       ...
                                       <tbody>
											<c:forEach items="${phoneList}" var="list" varStatus="counter">
							                	<tr style="display: table-row;">
							                	 <%-- <td><c:out value="${list.empName}" /></td> --%>
							                	 <td><c:out value="${counter.index + 1}" /></td>
							                           <td><c:out value="${list.phoneNo}" /></td>
