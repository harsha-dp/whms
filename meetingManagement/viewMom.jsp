                    ...
                    <div class="container">
                        ...
                        <li>
                            ...
                            <li class="hidden-xs hidden-sm">
                                <font class="page-title">EMPLOYEE MEETING TRACKER
                                   </font>
                            </li>
                        </ul>
			...
			<div class="content">
                   ...
                   <%--   <div class="panel-heading">
                        		...
                        		<div class="panel-heading">
                                 		<div class="form-group">
												<div class="col-sm-10">
													...
													<input type="text" name="fromDate" value="${fromDate}" id="datepickerautoclose" class="form-control input-sm" placeholder="dd/mm/yyyy"  />
													 <span class="input-group-addon bg-default b-0 text-black">To</span>
														<input type="text" name="toDate" value="${toDate}" id="datepickerautoclose1" class="form-control input-sm" placeholder="dd/mm/yyyy"  /> 
													</div>
												</div>
												<div class="col-md-2">
													<button type="submit"
								...
								<div class="panel-body">
								 <button class="btn btn-default waves-effect waves-light" data-toggle="modal" data-target="#con-close-modal"> 
								 <i class="zmdi zmdi-plus"></i>Add Meeting</button>
	                   <div class="row">
                    <div class="col-lg-12">
                        <div class="panel panel-color panel-tabs panel-info">
                            <div class="panel-heading">
                                <ul class="nav nav-pills pull-left">
                                    <li class="active">
                                        <a href="#navpills-1" data-toggle="tab" aria-expanded="true">Meeting Invites</a>
                                    </li>
                                    <li class="">
                                        <a href="#navpills-2" data-toggle="tab" aria-expanded="false">Meetings Assigned</a>
                                    </li>
                                </ul>
                                <h3 class="panel-title"><span style="color:blue">.</span></h3>
                            </div>
                            <div class="panel-body">
                                <div class="tab-content">
                                    <div id="navpills-1" class="tab-pane fade in active">
                                        <div class="row">
											...
											<tbody>
											<c:forEach items="${meetingAttendee}" var="list">
											<tr>
											<td>${list.mDate} & ${list.mTime} </td>
											<td><a href="viewMeetingById?id=<c:out value="${list.id}" />&meetingId=<c:out value="${list.meetingId}" />">${list.mName}</a></td>
											<td>${list.duration}</td>
											<td>${list.place}</td>
											<td>${list.empName}</td>
											<td>EDIT</td>
                                    ...
                                    <div id="navpills-2" class="tab-pane fade">
                                        <div class="row">
											...
											<tbody>
											<c:forEach items="${meetingAssignee}" var="list1">
											<tr>
											<td>${list1.mDate} & ${list1.mTime} </td>
											<td><a href="viewAssignedById?id=<c:out value="${list1.id}" />&meetingId=<c:out value="${list1.meetingId}" />">${list1.mName}</a></td>
                                            ...
                                            <div class="modal-content">
                                             <div class="n" id="n">
                                               <!--  <div class="modal-header"> -->
                                                   ...
                                                   <h4 class="custom-modal-title title-center">CREATE NEW MEETING</h4>
                                               <!--  </div> -->
                                                <div class="modal-body">
                                                  <div class="custom-modal-text text-left">
			                        <!--  <div class="container"> -->
                                                	<form action="saveMeeting" method="post">
                                                	<input type="hidden" name="hostId" value="${employeeById.empId}">
                                                    <div class="row">
                                                        <div class="col-md-8">
                                                         <label for="field-1" class="control-label">Meeting Host By: ${employeeById.empName}</label>
                                                            <div class="form-group">
                                                                <label for="field-1" class="control-label">Meeting Title</label>
                                                                <input type="text" name="mName" class="form-control" id="field-1" placeholder="Meeting Title">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                <label for="field-3" class="control-label">Meeting Description</label>
                                                                <textarea class="form-control" name="mDescription" id="field-3" placeholder="Meeting Agenda or Brief Introduction"></textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                <label for="field-4" class="control-label">Meeting Date</label>
                                                                <input type="text" name="mDate" class="form-control" id="datepickerautoclose2" placeholder="DD/MM/YYYY">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="time" name="mTime" class="form-control" id="field-4" placeholder="">
                                                            </div>
                                                        </div>
                                                        
                                                         <div class="col-md-4">
                                                            <div class="form-group">
                                                                <label for="field-1" class="control-label">Meeting Type</label>
                                                                <select name="mType" class="form-control input-md">
                                                                 <option label="select" disabled="disabled"></option>
                                                                 <option>Dept Internal</option>
                                                     ...
                                                     <div class="row">
                                                       <div class="col-md-12">
                                                            <div class="form-group">
                                                                <label for="field-5" class="control-label">Attendees</label>
                                                                 <select name="attendeeId" class="select2 select2-multiple" multiple="multiple" multiple data-placeholder="Select attendees Name">
                                        <optgroup label="ALl Employees List">
                                        <c:forEach items="${allEmployees}" var="empList">
                                            <option value="${empList.empId}">${empList.empName}</option>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label for="field-1" class="control-label">Meeting Duration</label>
                                                                <input type="text" name="duration" class="form-control" id="field-1" placeholder="00:00">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-9">
                                                            <div class="form-group">
                                                                <label for="field-2" class="control-label">Venue</label>
                                                                <input type="text" name="place" class="form-control" id="field-2" placeholder="Select Place">
                                                            </div>
                                                        </div>
                                                    </div>
                                                <div align="center">
