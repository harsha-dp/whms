                    ...
                    <div class="container">
                        ...
                        <li>
                            ...
                            <li class="hidden-xs hidden-sm">
                                <font class="page-title">BANNED IP
                                   </font>
                            </li>
                        </ul>
	                    ...
	                    <div class="row">
 						...
 						<table id="example" class="grid display nowrap" style="width: 100%">
                                       <thead>
											...
											<tbody>
											<c:forEach items="${bannedList}" var="list" varStatus="counter">
                        <tr>
							
                        	 <td><c:out value="${counter.index +1 }"/></td> 
                        	 <td><c:out value="${list.ipAddress}"/></td>
                        	 <td><c:out value="${list.reason}"/></td>
                        	 <td><c:out value="${list.bannedBy}"/></td>
                                    ...
                                    <div class="modal fade bs-example-modal-md" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" style="display: none;">
                                        <div class="modal-dialog modal-md">
                                            ...
                                            <div class="n" id="n">
                                                ...
                                                <form action="saveBannedIp" method="post">
                                                <div class="row">
                                                 <div class="col-sm-12">
                                              ...
                                              <!--   <label>Banned By :</label> -->
                                                <input type="hidden" name="bannedBy" value="${USERID}">
