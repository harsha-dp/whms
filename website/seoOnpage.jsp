                        ...
                        <ul class="nav navbar-nav navbar-left">
                          <li>
                            ...
                            <li class="hidden-xs hidden-sm"	>
                                <font class="page-title">SEO ON PAGE
                                   </font>
                            </li>
                        </ul>
           ...
           <div class="content-page">
			...
			<div class="content">
                  ...
                  <%--    <div class="panel-heading">
                        		...
                        		<div id="space">
										 <button class="btn btn-default waves-effect waves-light" data-toggle="modal" data-target=".bs-example-modal-lg"> Add SEO ONPAGE</button>
                                      </div>
	                    <div class="row">
                            <div class="col-sm-12">
                             <br />
                        ...
                        <tr>
                        	 ...
                        	 <td><a href="editSeoOnPage?id=<c:out value='${onlineList.id}' />"><u><c:out value="${onlineList.moduleName}"/></u></a></td>
                        	 <td><c:out value="${onlineList.title}"/></td>
                        	 <td><c:out value="${onlineList.description}"/></td>
                        	 <td><c:out value="${onlineList.keyword}"/></td>
                        	 <td><c:out value="${onlineList.robots}"/></td>
                        	 <td><c:out value="${onlineList.imgUrl}"/></td>
                        	 <td><c:out value="${onlineList.slug}"/></td>
                                        ...
                                        <div class="modal-dialog modal-lg">
                                            ...
                                            <div class="n" id="n">
                                                <div class="modal-header">
                                                    ...
                                                    <h4 class="modal-title title-text text-center" id="myLargeModalLabel">SEO ON PAGE</h4>
                                                </div>
                                                <div class="modal-body">
                                                <form action="saveSeoOnPage" method="post">
                                                ...
                                                <label>Robots :</label>
                                                <input type="text" name="robots" class="form-control" placeholder="">
