                    ...
                    <div class="container">
                        ...
                        <ul class="nav navbar-nav navbar-left">
                          <li>
                            ...
                            <li>
                             <a href="websiteDashBoard"> <i class="fa fa-home fa-2x" > </i>  </a>
                            </li>
                            <li class="hidden-xs hidden-sm">
                                <font class="page-title">ONLINE USER DATA
                                   </font>
                            </li>
                        </ul>
			...
			<div class="content">
                    <div class="container">
                     ...
                     <div class="panel-heading">
                                 	...
                                 	<div class="row">
                                 <form action="onLineUser1x" method="post" class="form-inline">		
                        		<div class="panel-heading">
  <div class="form-group">
	 <label class="" for="email">From:</label>
<input type="text" name="fromDate" value="${fromDate}" id="datepickerautoclose2" class="form-control input-sm" placeholder="dd/mm/yyyy"  />
</div>

<div class="form-group">
	 <label class="" for="email">To:</label>
<input type="text" name="toDate" value="${toDate}" id="datepickerautoclose3" class="form-control input-sm" placeholder="dd/mm/yyyy"  /> 
...
<div class="form-group">
	<button type="submit"
	                    ...
	                    <div class="row">
                            <div class="col-sm-12">
                             <br />
                                   <!--  <div id="space" style=" margin-left: 362px;margin-bottom: -33px;">
										 <button class="btn btn-default waves-effect waves-light" data-toggle="modal" data-target=".bs-example-modal-md"> Add BANNED IP</button>
                                      </div> -->
 						...
 						<table id="example" class="grid display nowrap" style="width: 100%">
                                       <thead>
											...
											<tbody>
											<c:forEach items="${onlineUserList}" var="onLinelIst" varStatus="counter">
                        <tr>
                        	 <td><c:out value="${counter.index + 1}"/></td> 
                        	 <td><a href="viewSubIpAddresDetails?ipAddress=<c:out value='${onLinelIst.ipAddress}'/> "><u><c:out value="${onLinelIst.ipAddress}" /></u></a></td>
                        	 <td><c:out value="${onLinelIst.TotalClick}"/></td>
                        	 <td><c:out value="${onLinelIst.city}"/></td>
                        	 <td><c:out value="${onLinelIst.region}"/></td>
                        	 <td><c:out value="${onLinelIst.countryName}"/></td>
                        	 <td><c:out value="${onLinelIst.urlLink}"/></td>
                        	 <td><c:out value="${onLinelIst.visitedDateTime}"/></td>
                        </tr>
                    </c:forEach>
	                						</tbody>
                                    </table>
                                        ...
                                        <div class="modal-dialog modal-md">
                                            ...
                                            <div class="n" id="n">
                                                <div class="modal-header">
                                                    ...
                                                    <h4 class="modal-title title-text text-center" id="myLargeModalLabel">BANNED IP</h4>
                                                </div>
