                        ...
                        <ul class="nav navbar-nav navbar-left">
                          <li>
                            ...
                            <li class="hidden-xs hidden-sm">
                                <font class="page-title">EDIT SEO ON PAGE
                                   </font>
                            </li>
                        </ul>
...
<br>
			...
			<form action="postEditSeoOnPage" method="post">
			<input type="hidden" name="id" value="${seoOnPageById.id}">
									<div class="row">
										<div class="col-md-4">
											<div class="p-20">
												<h5><b>Module Name</b></h5>
												<input type="text" class="form-control"  name="moduleName" value="${seoOnPageById.moduleName}" id="defaultconfig" />
											</div>
										</div><!-- end col -->
										...
										<div class="col-md-8">
											<div class="p-20">
												<h5><b>Title</b></h5>
												<input type="text" class="form-control" name="title" value="${seoOnPageById.title}"  id="alloptions" />
											</div>
										</div><!-- end col -->
										...
										<div class="col-md-12">
											<div class="p-20">
												...
												<input type="text" class="form-control"  name="description" value="${seoOnPageById.description}" id="defaultconfig" />
											</div>
										</div><!-- end col -->
										...
										<div class="col-md-12">
											<div class="p-20">
												<h5><b>Keyword</b></h5>
												<input type="text" class="form-control"   name="keyword" value="${seoOnPageById.keyword}" id="defaultconfig" >
											</div>
										</div><!-- end col -->
										...
										<div class="col-md-6">
											<div class="p-20">
												<h5><b>Robots</b></h5>
												<input type="text" class="form-control"  name="robots" value="${seoOnPageById.robots}" id="alloptions" />
											</div>
										</div><!-- end col -->
										...
										<div class="col-md-6">
											<div class="p-20">
												<h5><b>Image URL</b></h5>
												<input type="text" class="form-control"  name="imgUrl" value="${seoOnPageById.imgUrl}" id="alloptions" />
											</div>
										</div><!-- end col -->
										...
										<div class="col-md-6">
											<div class="p-20">
												<h5><b>Slug</b></h5>
												<input type="text" class="form-control" name="slug" value="${seoOnPageById.slug}" id="alloptions" />
											</div>
										</div><!-- end col -->
										</div>
										<div align="center">
