                        ...
                        <ul class="nav navbar-nav navbar-left">
                         <li>
                            ...
                            <li class="hidden-xs hidden-sm"	>
                                <font class="page-title">IP ADDRESS - ${ipAddress} </font>
                            </li>
                        </ul>
	                    ...
	                    <div class="row">
 						...
 						<table id="example" class="grid display nowrap" style="width: 100%">
                                       <thead>
											...
											<tbody>
											<c:forEach items="${onlineUserSubDetails}" var="onLinelIst" varStatus="counter">
                        <tr>
                        	 <td><c:out value="${counter.index + 1}"/></td> 
                        	 <td><c:out value="${onLinelIst.ipAddress}" /></td>
