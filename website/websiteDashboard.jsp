                        ...
                        <ul class="nav navbar-nav navbar-left">
                         <li>
                            ...
                            <li class="hidden-xs hidden-sm"	>
                             <font face="verdana" class="page-title">WEBSITE</font>
                            ...
                            <div class="col-md-6 col-lg-4">
                                <div class="widget-bg-color-icon card-box fadeInDown animated">
                                    ...
                                    <div class="text-right">
                                        ...
                                        <p class="text-muted"><a href="onLineUser"><b>ONLINE USERS </b></a></p>
                                    </div>
                            ...
                            <div class="col-md-6 col-lg-4">
                                <div class="widget-bg-color-icon card-box fadeInDown animated">
                                    ...
                                    <div class="text-right">
                                        ...
                                        <p class="text-muted"><a href="seoOnpage"><b>SEO ON PAGE</b></a></p>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                            </div>
                             ...
                             <div class="col-md-6 col-lg-4">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        <h3 class="text-dark"><b class="counter"><br></b></h3>
                                        <p class="text-muted"><a href="bannedIpList"><b>BANNED IP</b></a></p>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                            </div>
