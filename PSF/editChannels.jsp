				...
				<div class="container">
					...
					<ul class="nav navbar-nav navbar-left">
					  <li>
						...
						<li class="hidden-xs hidden-sm"><font face="verdana" class="page-title">EDIT CHANNELS
			...
			<br>
				<div class="card-box">
					<div class="row">
								...
								<form:form class="form-horizontal" action="saveEditChannels"  modelAttribute="channel">
                                     
                                      <div class="col-md-12">
                                     <label>Channels Name </label>
                                       <form:input type="text" path="channelsName" class="form-control" value="${channel.channelsName}" />
                                     </div>
