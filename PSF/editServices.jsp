				...
				<div class="container">
					...
					<ul class="nav navbar-nav navbar-left">
						...
						<li class="hidden-xs hidden-sm">
							...
							color="" class="page-title">EDIT SERVICES</font>
						</li>
					</ul>
						...
						<div class="modal-dialog">
							<div class="modal-content">
								<div class="modal-header">
									...
									<h4 class="custom-modal-title">EDIT SERVICES</h4>
									<div class="custom-modal-text text-left">

										<!-- =============	form:form start from here ==============    -->

										<form:form action="editsaveProducts"
														...
														<div class="card-box">
															<div class="col-md-12">
																...
																<form:input type="text" path="productName"
																	value="${allproducts.productName}" id="contactnumber"
																	class="form-control" />
															</div>
															...
															<div class="col-md-12">
																...
																<form:input type="text" path="productPrice"
																	value="${allproducts.productPrice}" id="contactnumber"
																	class="form-control" />
															</div>
															...
															<div class="col-md-6">
																<div class="form-group">
																	...
																	<div class="input-group">
																		<form:input type="text" path="validTill"
																			value="${allproducts.validTill}"
															...
															<div class="col-md-6">
																<div class="form-group">
																	<label>Productid ccavenue </label>
																	<div class="input-group">
																		<form:input type="text" path="prodidCcavenue"
																			value="${allproducts.prodidCcavenue}"
																			class="form-control" />
																...
																<div class="form-group">
																	...
																	<div class="input-group">
																		<form:input type="text" path="isActive"
																			value="${allproducts.isActive}" class="form-control" />
																	</div>
																</div>
															</div>
															...
															<div align="center">
																<button type="submit"
																	class="btn btn-custom btn-rounded waves-effect waves-light w-md m-b-5">Save
																	Products</button>
															</div>
														</div>
													</div>
