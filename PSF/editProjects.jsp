			...
			<br>
				<div class="card-box">
					<div class="row">
								...
								<form:form class="form-horizontal" action="editSaveprojects"  modelAttribute="allprojects">
                                     <form:hidden path="projectId"/>
                                     
                                      <div class="col-md-6">
                                     <label>Project Name </label>
                                       <form:input type="text" path="projectName" class="form-control" value="${allprojects.projectName}" />
                                     </div>
                                   
                                       <div class="col-md-6">
                                        <label>Parent Project</label>
                                       <form:input type="text" path="parentProject" class="form-control" value="${allprojects.parentProject}" />
                                        </div>
