			...
			<div class="navbar navbar-default" role="navigation">
				<div class="container">
					...
					<ul class="nav navbar-nav navbar-left">
						...
						<li class="hidden-xs hidden-sm"><font face="verdana" class="page-title">EDIT TEAMS
			...
			<br>
				<div class="card-box">
					<div class="row">
								...
								<form:form class="form-horizontal" action="saveeditteams"  modelAttribute="allteam">
                                     
                                      <div class="col-md-6">
                                     <label>Team Name </label>
                                       <form:input type="text" path="teamName" class="form-control" value="${allteam.teamName}" />
                                     </div>
                                   
                                       <div class="col-md-6">
                                        <label>Leader Name</label>
                                       <form:input type="text" path="leaderName" class="form-control" value="${allteam.leaderName}" />
                                        </div>
