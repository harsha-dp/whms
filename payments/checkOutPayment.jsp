                        ...
                        <ul class="nav navbar-nav navbar-left">
                          <li>
                            ...
                            <li class="hidden-xs hidden-sm"	>
                                <font class="page-title">CHECK OUT PAYMENTS</font>
                            </li>
                        </ul>
...
<!-- ========== Left Sidebar Start ========== -->
 ...
 <table id="example" class="grid display nowrap" style="width: 100%">
                        ...
                        <tr>
                        	...
                        	<%--  <td><c:out value="${payment.approvalBy}"/></td>  --%>
                        	 <td><c:out value="${payment.txStatus}"/></td> 
                        	<td>
                        	<%-- <a href="leadView?paymentId=<c:out value='${payment.paymentId}'/>"><i class="fa fa-eye" aria-hidden="true"></i></a> --%>
                        	<c:if test="${payment.txStatus !='New'}">
                       <a href="reCollectPayment?paymentId=<c:out value='${payment.transactionId}'/>"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
                      </c:if>
                       </td>
                        </tr>
