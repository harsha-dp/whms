                    ...
                    <div class="container">
                        ...
                        <ul class="nav navbar-nav navbar-left">
                         <li>
                            ...
                            <li>
                             <a href="txdashboard"> <i class="fa fa-home fa-2x" > </i>  </a>
                            </li>
                            <li class="hidden-xs hidden-sm">
                                <font class="page-title">VIEW PAYMENTS </font>
                            </li>
                        </ul>
			...
			<div class="content">
                    ...
                    <div class="container">
                     ...
                     <div class="panel-heading">
                                 	...
                                 	<div class="row">
                                  <form:form action="filterPayments"  modelAttribute="viewaccounts" class="form-inline">		
                        		<div class="panel-heading">
                        		<div class="col-sm-12">
                        		<div class="form-group">
	 <label class="" for="email">Submitted Between:</label>
<form:input type="text" path="paymentStatus" value="${fromdate}" id="datepicker-autoclose" class="form-control input-sm"  />
</div>	 
		
		<div class="form-group">
	 <label class="" for="email">And:</label>
<form:input type="text" path="cardNumber" value="${toDate}" id="datepicker-autoclose1" class="form-control input-sm"  />
</div>	 
		
		<div class="form-group">
	 <label class="" for="email">Payment Status:</label>
<form:select path="txStatus" title="----Application status----"  id="assign" class="form-control input-sm">
																<form:option value="" label="select Application status" ></form:option>
																<form:option path="txStatus" value="New">New</form:option>
																<form:option path="txStatus" value="Not Approved">Not Approved</form:option>
																<form:option path="txStatus" value="Payment Approved">Payment Approved</form:option>
																<form:option path="txStatus" value="Cheque Returned" >Cheque Returned</form:option>
																</form:select>
</div>	 
                    ...
                    <button> <a class="btn btn-info" href="bulkpayment" >Cheque Presentation</a> </button>&nbsp;&nbsp;&nbsp;
                   <button> <a class="btn btn-info" href="bulkpaymentOthers" >Payment Approval</a></button> 
                  </div>
                  </div>
 ...
 <table id="example" class="grid display nowrap" style="width: 100%">
                                       <thead>
											...
											<tbody>
											<c:forEach items="${alltransaction}" var="payment">
                        ...
                        <tr>
							<td><c:out value="${payment.transactionId}"/></td>
                        	 ...
                        	 <td><c:out value="${payment.csr}"/></td> 
                       		 <td><c:out value="${payment.collectedDate}"/></td> 
                        	 <td><c:out value="${payment.txStatus}"/></td> 
                        	<td>
                        	<c:if test="${(payment.txStatus !='Cheque Returned') and (payment.txStatus !='Payment Approved')}">
                       <a href="editpayment?paymentId=<c:out value='${payment.transactionId}'/>"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
                       </c:if>
                       <c:if test="${(payment.txStatus =='Payment Approved')}">
                       <a ><i class="fa fa-check-square" aria-hidden="true"></i></a>
                       </c:if>
                        <c:if test="${(payment.txStatus =='Cheque Returned')}">
