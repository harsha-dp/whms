...
<script src="resources/HR/fullcalendar/lib/fullcalendar.min.css"></script>
<script src="resources/HR/fullcalendar/lib/fullcalendar.print.min.css"></script>
<script src="resources/HR/fullcalendar/lib/cupertino/jquery-ui.min.css"></script>
				...
				<div class="container">
					...
					<ul class="nav navbar-nav navbar-left">
					  <li>
						...
						<li class="hidden-xs hidden-sm"	><font class="page-title">HEALTH APPOINTMENT CALENDER : </font></li>
					</ul>
                ...
                <div class="content">
                    <div class="container">
                            ...
                            <div class="col-sm-12">
								...
								<div id="mycalendar" style="width: 100%; height: 500px;display: inline-block;">
								...
								<script type="text/javascript">
									...
									$.each(callsObj, function(i, item) {
										...
										callDate = item.date; //May, 26 Oct 2014 13:00:00 EST
											noPharmacy = item.pharmacy;
										noHealthcheck =	item.healthcheck;
										noConsultation=item.consultation;
										noDentistry	=item.dentistry;
											
										var eventObject = {
											title : 'Total Appointments : '+ total +' \n Health Check : '+noHealthcheck + '\n Consultation : '+noConsultation+' \n Dentistry : '+noDentistry,
												start : callDate,
											allDay : true,
											url :'viewappointmentList?fromDate='+callDate+'&toDate='+callDate ,
										};
