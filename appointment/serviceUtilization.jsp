                        ...
                        <ul class="nav navbar-nav navbar-left">
                           <li>
                            ...
                            <li class="hidden-xs hidden-sm"	>
                                <font class="page-title">HEALTH APPOINTMENT SUMMARY</font>
                            </li>
                        </ul>
			...
			<div class="content">
                    ...
                    <div class="container">
                     ...
                     <div class="panel-heading">
                                 	...
                                 	<div class="row">
                                   <form action="healthapptsummary" method="post" class="form-inline">		
                        		<div class="panel-heading">
...
<div class="form-group">
	 <label class="" for="email">Group By:</label>
<select name="groupByPhrase1" title="----Select----" id="assign" class="form-control input-sm">
																<option  value="${groupByPhrase}" label="${groupByPhrase}" ></option>
																<option  Value="Health Care">Health Center</option>
 ...
 <table id="example" class="grid display nowrap" style="width: 100%">
                                        <thead>
                                       	<%--  <c:out value="${columnName.size()}"></c:out> --%>
                                            ...
                                            <td class="filtername">${name.columnName}</td>
									</c:forEach>
                                   </tr>
                                        </thead>
