                        ...
                        <ul class="nav navbar-nav navbar-left">
                         <li>
                            ...
                            <li class="hidden-xs hidden-sm">
                                <font class="page-title">VIEW CUSTOMER INTERACTION</font>
                            </li>
                        </ul>
			...
			<div class="content">
                    ...
                    <div class="container">
                     ...
                     <div class="panel-heading">
                                 	...
                                 	<div class="row">
                                  <form:form action="viewinteractions"  modelAttribute="healthAppointmentDTO" class="form-inline">		
                        		<div class="panel-heading">
...
<input type="text" name="toDate" value="${toDate}" id="datepicker-autoclose1" class="form-control input-sm"  /></div>	 
			

                           	<div class="form-group">
	 <label class="" for="email">Purpose:</label>
<select name="purpose" title="purpose" id="assign" class="form-control input-sm">
																...
																<option  Value="Customer Engagement (Relationship)">Customer Engagement (Relationship)</option>
																<option  Value="Voucher Exchange">Voucher Exchange</option>
																</select>
							</div>
							
							                          	<div class="form-group">
	 <label class="" for="email">InterAction Mode:</label>
<select name="mode" title="Mode" id="assign" class="form-control input-sm" >
...
<select name="status" title="Status" id="assign" class="form-control input-sm" >
 ...
 <table id="example" class="grid display nowrap" style="width: 100%">
                                        <thead>
                                            <tr>
                                             ...
                                             <c:if test="${name.columnName ne 'transaction_id'}">
                                            <td><b>${name.columnName}</b></td>
                                            </c:if>
									</c:forEach>
                                            <td class="filtername1">Action</td>
                                   </tr>
                                        </thead>
                                        ...
                                        <tfoot>
                                            ...
                                            <th class="filtername1">Action</th>
                                   </tr>
                                        </tfoot>
                          ...
                          <c:forEach var="row" items="${stkList}"> 
                                ...
                                <tr>
                                   ...
                                   <c:if test="${columnName.size() >= 2}"><td><a href="serviceBaseAppointment?transactionId=<c:out value='${row.attr8}'/>">${row.attr2}</a></td></c:if>
                                   ...
                                   <c:if test="${columnName.size() >= 5}"><td>${row.attr5}</td></c:if>
                                    ...
                                    <td>
                                    <c:if test="${row.attr7 == 'Open'}">
                                    <p class="label label-danger">${row.attr7}</p></c:if>
                                    <c:if test="${row.attr7 == 'In Process'}">
                                    <p class="label label-primary">${row.attr7}</p></c:if>
                                    <c:if test="${row.attr7 == 'Closed'}">
                                    <p class="label label-success">${row.attr7}</p></c:if>
                                    </td></c:if>
                                   ...
                                   <c:if test="${columnName.size() >= 9}"><td>${row.attr9}</td></c:if>
                                    <c:if test="${columnName.size() >= 10}"><td>${row.attr10}</td></c:if>
                                     <c:if test="${columnName.size() >= 11}"><td>${row.attr11}</td></c:if>
                                          ...
                                          <a href="editInteraction?interactionId=<c:out value='${row.attr1}'/>"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
                                         </c:if>
                                          </td>
            </tr>
