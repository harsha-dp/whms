                        ...
                        <ul class="nav navbar-nav navbar-left">
                         <li>
                            ...
                            <li class="hidden-xs hidden-sm">
                                <font class="page-title">CUSTOMER REPORT LIST</font>
                            </li>
                        </ul>
...
<select name="status" title="Status" id="assign" class="form-control input-sm" >
 	...
 	<table id="example" class="grid display nowrap"
													...
													<tbody>
														<c:forEach items="${customerReportList}" var="list"
															varStatus="counter">

															<tr>
																<td><c:out value="${counter.index + 1}" /></td>
																<td><a href="viewAppointmentsById?appointmentId=<c:out value='${list.appointmentId}'/>"
																	><c:out value="${list.CustomerName}" /></a></td>
																<td><c:out value="${list.Service}" /></td>
																<td><c:out value="${list.ApptFor}" /></td>
																<td><c:out value="${list.ServiceCentre}" /></td>
																<td><c:out value="${list.ApptDate}" /></td>
