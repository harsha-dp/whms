                        ...
                        <ul class="nav navbar-nav navbar-left">
                           <li>
                            ...
                            <li class="hidden-xs hidden-sm"	>
                               ...
                               <font  class="page-title1">EDIT EXTENSION</font>
                            </li>
                        </ul>
...
<br>
			    ...
			    <h4 class="custom-modal-title">Edit Extension</h4>
			    <div class="custom-modal-text text-left">
			    
	<!-- =============	form:form start from here ==============    -->	    
			    
                 <form:form action="postEditExtension" modelAttribute="extensions">
                 <form:hidden path="id" value="${extension.id}" />
			    ...
			    <div class="card-box">
										...
										<label>Extension Number</label>
										 <form:input type="text" path="extensionNo" value="${extension.extensionNo}" id="contactnumber" class="form-control" /> 
												</div>
												</div>
											...
											<form:option value="${extension.empId}" ><c:out value="${extension.empName}"></c:out></form:option>
											<c:forEach var="employee" varStatus="status" items="${allEmployees}">
												<form:option path="empId" value="${employee.empId}">${employee.empName}</form:option>
											</c:forEach>
										      `</form:select>
												</div>
												</div>
											...
											<form:option value="${extension.team}" label="${extension.teamName}" />
									       ...
									       <form:select path="channel" class="form-control">
											<form:option value="${extension.channel}" label="${extension.channelsName}"></form:option>
											 <c:forEach var="channel" varStatus="status"	items="${allChannels}">
												<form:option path="channel" value="${channel.channelId}">${channel.channelsName}</form:option>
											</c:forEach>
										</form:select> 
												</div>
												</div>
												...
												<div class="col-md-6">
												 <div class="form-group">
													...
													<form:input type="text" path="fromDate" value="${extension.fromDate}" id="datepickerautoclose" class="form-control" />
										...
										class="ti-calendar"></i></span>
												...
												<div class="col-md-6">
												 <div class="form-group">
													<label>To Date</label>
													<div class="input-group">
													<form:input type="text" path="toDate" value="${extension.toDate}" id="datepickerautoclose1" class="form-control" />
												   <span class="input-group-addon bg-primary b-0 text-white"><i
										class="ti-calendar"></i></span>
												 </div>
												</div>
									...
									<form:option value="${extension.department}"></form:option>
									<c:forEach var="dept" varStatus="status" items="${allDepartment}">
											<form:option  value="${dept.department}">${dept.department}</form:option>
												...
												<div align="center">
												<button type="submit" class="btn btn-custom btn-rounded waves-effect waves-light w-md m-b-5">CLOSE EXTENSTION</button>
			    	</div>
			    </div>
			    </div>
			    </div>
