                        ...
                        <ul class="nav navbar-nav navbar-left">
                          <li>
                            ...
                            <li class="hidden-xs hidden-sm">
                                <font class="page-title1">CSR INDIVIDUAL CALLS REPORT</font> 
                            </li>
                        </ul>
			...
			<div class="content">
                    ...
                    <div class="container">
                     ...
                     <div class="panel-heading">
                                 	...
                                 	<div class="row">
                                  <form action="csrIndividualCallsReports"  method="post" class="form-inline"> 			
                        		<div class="panel-heading">
...
<div class="form-group">
	 <label class="" for="email">CSR Name:</label>
<select name="csrName" title="----Csr Name----" id="assign" class="form-control input-sm">
																<option  value="${csrName}" label="${csrName}" ></option>
...
<div class="form-group">
 ...
 <table id="example" class="grid display nowrap" style="width: 100%">
                                        ...
                                        <tbody>
                                            <c:forEach items="${callsList}" var="calls" varStatus="counter">
                                            
                        <tr align="center">
                        	<td><c:out value="${counter.index + 1}"/></td>
                        	<td><c:out value="${calls.csrName}"/></td>
                        	<td><c:out value="${calls.callDate}"/></td>
                        	<td><c:out value="${calls.totalCalls}"/></td> 
                        	<td><c:out value="${calls.presentations}"/></td> 
