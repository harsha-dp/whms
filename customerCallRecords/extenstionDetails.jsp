                    ...
                    <div class="container">
                        ...
                        <ul class="nav navbar-nav navbar-left">
                            ...
                            <li class="hidden-xs hidden-sm"	>
                                <font class="page-title">EXTENSION DETAILS :</font>
                            </li>
                        </ul>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box table-responsive">
                                   ...
                                   <tbody>
                                            <c:forEach items="${extenstion}" var="extns">
                                            <c:if test="${extns.empName != null}">
                        <tr>
                        	<td class="account-id"><c:out value="${extns.extensionNumber}"/></td>
                        	 <td class="account-name sort-value"><c:out value="${extns.empName}"/></td>
                        	 <td class="account-name1 sort-value"><c:out value="${extns.empEmail}"/></td>
                        	 <td class="account-name2 sort-value"><c:out value="${extns.empMobile}"/></td>
                        	<%--  <td class="account-name3 sort-value"><c:out value="${extns.empId}"/></td> --%>
                        </tr>
                        </c:if>
                    </c:forEach>
                                        </tbody> 
