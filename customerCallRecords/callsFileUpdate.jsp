...
<!--add file validation  -->
<script src="resources/validation/customerCallRecords/callsFileUpdate.js"></script>
<!--  -->
         </head>
                    ...
                    <div class="container">
                        ...
                        <ul class="nav navbar-nav navbar-left">
                         <li>
                            ...
                            <font class="page-title">UPLOAD DATA RECORDS FILES </font>
                            </li>
                        </ul>
				...
				<div class="row">
                            <div class="col-sm-7">
                                ...
                                <div class="well well-lg">
                                   <form method="post" action="callsData" name="form" onsubmit="return validate()" enctype="multipart/form-data">
            <table>
         
             <tr>
             <td><p><font size="3" color="blue">Upload Excel Sheet Here <i class="fa fa-arrow-down" aria-hidden="true"></i></font></p>
             </td>
             </tr>
                 <tr class="separator">
                 <td><b>Source Details <span style="color:red">*</span></b>:</td>
                  <td><textarea name="details" id="source" cols="60" rows="2" class="form-control" style="min-width: 100%"></textarea>
                   <font id="sourceerror" style="color:red"></font>
                  </td>
                 </tr>
                  <tr>
             <td><h6></h6></td>
                  ...
                  <tr class="separator">
                 <td><b>Provided By <span style="color:red">*</span></b>:</td>
                  <td><input type="text" name="name" id="prov" class="form-control ">
                   <font id="proverror" style="color:red"></font>
                  </td> 
                 </tr>
             ...
             <td><h6></h6></td>
                  ...
                  <tr class="separator">
                 	<td><b>Quantity <span style="color:red">*</span></b>:</td>
                 	 <td><input type="text" name="quantity" id="quant" class="form-control">
                 	  <font id="quanterror" style="color:red"></font>
                 	 </td>
                 </tr>
                <tr>
                <td><br/></td>
                 ...
                 <tr>
                    ...
                    <font id="uploaderror" style="color:red"></font>
                    </td>
                </tr>
             ...
             <td><h6></h6></td>
                ...
                <tr>
                    ...
                    <i class="fa fa-upload" aria-hidden="true"></i> Upload
                                ...
                                <div class="card-box table-responsive">
                                <div class="well well-lg">
                                   <form method="post" action="callUpload" name="form1" onsubmit="return validate1()" enctype="multipart/form-data">
            <table>
             <tr class="separator">
             <td><p><font size="3" color="blue">Upload Call Here <i class="fa fa-arrow-down" aria-hidden="true"></i></font></p>
             </td>
             </tr>
                 <tr>
                    <td><b> Select file </b><span style="color:red">*</span></td>
                    <td><input type="file" name="file" id="uploads"/>
                    <font id="uploaderrors" style="color:red"></font>
                    </td>
                </tr>
             ...
             <td><h6></h6></td>
                ...
                <tr>
               <td colspan="2" align="center"><button type="submit" value="Upload" class="btn btn-primary" onclick="return validate1()">
                    <i class="fa fa-upload" aria-hidden="true"></i> Upload
                </button></td>
                </tr>
