...
.loader {
    ...
    height: 100%;
    z-index: 9999;
    background: url('resources/images/pageLoader1.gif') 50% 50% no-repeat rgb(249,249,249);
    opacity: .8;
                        ...
                        <ul class="nav navbar-nav navbar-left">
                         <li>
                            ...
                            <li class="hidden-sm hidden-xs">
                                <font class="page-title">CALLS SUMMARY</font>
                            </li>
                        </ul>
...
<!-- ========== Left Sidebar Start ========== -->
			...
			<div class="content">
                   ...
                   <!--   <div class="loader"></div> -->
                     ...
                     <div class="panel-heading">
                                    ...
                                    <div class="row">
                                    <form action="callDetails" method="post" class="form-inline">			
                        		     <div class="panel-heading">
                        		
                     <div class="col-sm-12" style="width:105%;">										
	<div class="form-group">
	 <label class="" for="email">From:</label>
     <input type="text" name="fromDate" id="datepicker-autoclose" value="${fromDate}" class="form-control input-sm"  />
    </div>
    ...
    <select name="groupBy"  class="form-control input-sm" onchange="this.form.submit()" >
																<option value="${groupBy}" label="${groupBy}">${groupBy}</option>
																<option value="Calls Report">Calls Report</option>
																<option value="Hourly Report">Hourly Report</option>
															    <option value="Average Calls">Average Calls</option>
																</select>
    </div>
    ...
    <table id="datatable" class="table table-striped table-bordered">
                                ...
                                <tr>
                                  ...
                                  <%--  <c:if test="${columnName.size() >= 2}"><td>${row.attr2}</td></c:if> --%>
                                	...
                                	<c:if test="${columnName.size() >= 2}"><td>
                                    <c:if test="${row.attr2 < 75}"><p class="label label-danger">${row.attr2}</p> </c:if>
                                    <c:if test="${(row.attr2 >= 75)&&(row.attr2 < 100)}"><p class="label label-success">${row.attr2}</p></c:if>
                                    <c:if test="${(row.attr2 >= 100)&&(row.attr2 < 125)}"><p class="label label-info">${row.attr2}</p></c:if>
                                    <c:if test="${(row.attr2 >= 125)&&(row.attr2 < 150)}"><p class="label label-warning">${row.attr2}</p></c:if>
                                    <c:if test="${(row.attr2 >= 150)&&(row.attr2 < 200)}"><p class="label label-primary">${row.attr2}</p></c:if>
                                    <c:if test="${row.attr2 >= 200}"><p class="label label-pink">${row.attr2}</p></c:if>
                                    </td></c:if>
                        	  ...
                        	  <div class="row">
                                 <div class="col-md-12" >
                            		...
                            		<form action="attendance1" >
									 
                            		<c:if test="${groupBy  == 'Calls Report'}">
									<P><span class="label label-danger"> Calls Status < 75 </span> Poor 
			                         <span class="label label-success"> >= 75 & < 100 </span> Average
			                          <span class="label label-info"> >= 100 & < 125</span> Good
			                         <span class="label label-warning"> >= 125 & < 150 </span> Very Good 
			                          <span class="label label-primary"> >= 150 & < 200 </span> Excellent 
			                          <span class="label label-pink"> >= 200 </span>Very Excellent</P>
			                         </c:if>
			                         
			                         <c:if test="${groupBy  == 'Hourly Report'}">
									<p><span class = "label label-default"> FullDay </span>00:00:00 AND 23:59:59 
			                         <span class = "label label-default"> FirstHalf</span>00:00:00 AND 13:29:59 
			                         <span class = "label label-default"> SecondHalf</span>13:30:00 AND 23:59:59
			                         <span class = "label label-default"> Before 11 </span>'00:00:00' AND 10:59:59 
			                         <span class = "label label-default"> 11 to 12  </span>11:00:00 AND 11:59:59
			                         <span class = "label label-default"> After 6  </span>18:00:00 AND 23:59:59</p>
			                         </c:if>
	                      ...
	                      <%--     <%@ include file="/WEB-INF/jsp/presales/table.jsp" %> --%>
