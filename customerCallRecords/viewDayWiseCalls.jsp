                        ...
                        <ul class="nav navbar-nav navbar-left">
                         <li>
                            ...
                            <li class="hidden-xs hidden-sm"	>
                                <h4 class="page-title"><u>VIEW CALLS DATE WISE :</u></h4>
                            </li>
                        </ul>
                            ...
                            <div class="col-sm-12">
                                <div class="card-box table-responsive">
                                    ...
                                    <table id="datatable-buttons" class="table table-striped table-bordered">
                                        <thead>
                                            <tr>
                                            <th class="filtername"><b>CALL DATE</b></th>
                                                <th class="filtername1"><b>TOTAL CALLS</b></th>
                                                <th class="filtername2"><b>TOTAL DURATION</b></th>
                                                <th class="filtername3"><b>PRESENTATION</b></th>
                                            </tr>
                                        </thead>
                                   <tbody>
                                            <c:forEach items="${allDailyCalls}" var="calls">
                        <tr>
                        	
<td class="account-name sort-value"><a href="viewCallsByDate?callDate=<c:out value="${calls.callDate}" />"><u><c:out value="${calls.callDate}"/></u></a></a></td>
                        	<td class="account-name1 sort-value"><c:out value="${calls.totalCalls}"/></td>
                        <td class="account-name2 sort-value"><c:out value="${calls.totalDuration}"/></td>
                        <td class="account-name3 sort-value"><c:out value="${calls.presentations}"/></td> 
                        </tr>
                    </c:forEach>
                                        </tbody> 
                                    </table>
