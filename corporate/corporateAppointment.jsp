			...
			<div class="navbar navbar-default" role="navigation">
				<div class="container">
					...
					<li>
						...
						<font face="verdana"  class="page-title"> ${corporateName}</font>
					...
					<div class="modal-dialog modal-lg">
						...
						<div class="panel panel-default">
							<div class="panel-heading">
								<h4 class="modal-title text-rigth">NEW APPOINTMENT FORM</h4>
								</div>
								<div class="custom-modal-text text-left">
									<!-- =============	form:form start from here ==============    -->
									<form:form action="saveCorporateAppointment" name="form" onsubmit="return validate()" modelAttribute="corporateDTO" >
									
									<form:hidden path="createdBy" value="<%=id %>" class="form-control"  />
									<form:hidden path="corporateId" value="${corporateID}"/>
									<form:hidden path="contactId" value="${contactById.contactId}"/>
									<%-- 	<div class="form-group">
											<form:label path="corporateName" for="name">Corporate Name</form:label>
											<form:input type="text"	
												path="corporateName" value="${corporateName}" class="form-control" id="name" placeholder="Enter corporate name"
												readonly="true" />
										</div>
										 --%>
										 <div class="row">
										   ...
										   <div class="col-lg-6">
										          <div class="form-group">
												       <label for="name">Contact Name <span style="color:red;">*</span></label>
                                                             <form:input type="text" path="name" class="form-control" onkeypress="return onlyAlphabets(event,this);" value="${contactById.name}"
                                                                                  id="namee" placeholder="Enter contact preson name"  />
										...
										<div class="form-group">
											<label  for="name">Designation <span style="color:red;">*</span></label>
                                                                           <form:input type="text" path="designation" class="form-control" value="${contactById.designation}"
                                                                                  id="desiname" placeholder="enter Designation" />
										...
										<%-- <div class="col-md-6">
												<div class="form-group">
													<label  for="priority">DOB(dd/mm/yyyy)</label>
											<form:input type="text" path="dob" 	class="form-control" value="${contactById.dob}" id="datepicker1" placeholder="dd/mm/yyyy"/>
												</div>
											</div> --%>
											...
											<div class="col-md-6">
												<div class="form-group">
													<label  for="priority">Mobile Number<span style="color:red;">*</span></label>
													<form:input type="text" value="${contactById.primaryMob}"
														path="primaryMob" class="form-control" id="number"  placeholder=""
														 />
														 <font id="desinagmeerror" style="color:red"></font>
										...
										<%-- <div class="form-group">
											<label  for="name">Person Address:</label>
											<form:textarea path="residenceAddresss" id="textarea"
														class="form-control" maxlength="225" rows="2" required="required" />
										</div>
										<div class="row">
											<div class="col-md-6">
												<div class="form-group">
													...
													<form:input type="text"
														onkeypress="return onlyAlphabets(event,this);" path="city"	 class="form-control"
														id="priority" placeholder="city"  />
												</div>
											</div>
											<div class="col-md-6">
												<div class="form-group">
													<label for="priority">Pincode</label>
													<form:input type="text" maxlength="6" onkeypress="return IsNumeric(event);"
										...
										<div class="row">
											...
											<div class="col-md-6">
												<div class="form-group">
													...
													<form:input type="text"  onkeypress="return IsNumeric(event);"
														ondrop="return false;" onpaste="return false;"
														path="landline" class="form-control" id="priority" placeholder="enter landline no" />
												</div>
											</div>
										</div> --%>
										 <div class="col-lg-12">
											<div class="col-md-6">
												<div class="form-group">
													<label for="priority"> Date of Appointment <span style="color:red;">*</span></label>
										...
										class="fa fa-calendar"></i></span>
														...
														<font id="dateeerror" style="color:red"></font>
												</div>
											</div>
                                           
											<div class="col-md-6">
												<div class="form-group">
													<label for="priority">Time of Appointment <span style="color:red;">*</span></label>
								<form:select path="timeAppointment" title="----TOA----"	class="form-control" id="timee" >
									<form:option value="" label="select time slot"></form:option>
								...
								<font id="timeeerror" style="color:red"></font>
												</div>
											</div>
											</div>
											<div class="col-md-12">
											<div class="col-md-6">
												<div class="form-group">
									<label for="priority">Executive <span style="color:red;">*</span></label>
										<form:select path="executive" title="----Select Executive----"	class="form-control" id="exceutive">
									...
									<font id="exceutiveerror" style="color:red"></font>
												</div>
											</div>
										</div>
										...
										<div class="col-md-12">
											<div class="col-md-4">
												<div class="form-group">
									<label for="priority">Status <span style="color:red;">*</span></label>
										<form:select path="status" title="Select Executive"	class="form-control" id="statuss">
