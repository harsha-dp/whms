                        ...
                        <ul class="nav navbar-nav navbar-left">
                         ...
                         <li>
                            ...
                            <li class="hidden-xs hidden-sm">
                                <font class="page-title">PRE-EMPLOYMENT LIST</font>
                            </li>
                        </ul>
                                    ...
                                    <table id="example" class="grid display nowrap" style="width: 100%">
                                        <thead>
                                            <tr>
                                              <td><b>SL NO</b></td>
                                               ...
                                               <td><b>CONTACT NUMBER</b></td>
                                                <td><b>APPT. LOCATION</b></td>
                                               <td><b>HEALTH CHECK UP</b></td>
                                               <td><b>TIME</b></td>
                                         ...
                                         <tfoot>
                                            <tr>
                                              <th><b>SL NO</b></th>
                                               <th><b>EMPLOYE NAME</b></th>
                                               <th><b>CORPORATE NAME</b></th>
                                               <th><b>CONTACT NUMBER</b></th>
                                                <th><b>APPT. LOCATION</b></th>
                                               <th><b>HEALTH CHECK UP</b></th>
                                               <th><b>TIME</b></th>
                                        ...
                                        <tbody>
                                            <c:forEach items="${allPreEmployeeList}" var="emp" varStatus="counter">
                                            
                        <tr>
                        	<td><c:out value="${counter.index + 1}"/></td>
                        	<td><c:out value="${emp.empName}"/></td>
                        	<td><c:out value="${emp.corporateName}"/></td>
                        	<td><c:out value="${emp.contactNo}"/></td>
                        	<td><c:out value="${emp.appointmentLocation}"/></td> 
                        	<td><c:out value="${emp.productName}"/></td> 
                        	<td><c:out value="${emp.time}"/></td> 
                        	<td><c:out value="${emp.doa}"/></td> 
                        	
                        <td>
                        <c:if test="${emp.status == 'In Progress'}">
                        	<a href="viewPreEmpQuery?id=<c:out value='${emp.id}'/>&userId=<c:out value='<%=id%>'/>">
                        	<i class="fa fa-pencil-square-o" aria-hidden="true"></i>Confirm</a>
                        	</c:if>
                        	<c:if test="${emp.status != 'In Progress'}">
                        	<i class="fa fa-check-square-o" aria-hidden="true"></i>${emp.status}</a>
                        	</c:if>
                        	</td>
                        </tr>
                    </c:forEach>
