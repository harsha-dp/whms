                        ...
                        <ul class="nav navbar-nav navbar-left">
                           <li>
                            ...
                            <li class="hidden-xs hidden-sm"	>
                                <font class="page-title">LIST OF CORPORATE INTERACTION</font>
                            </li>
                        </ul>
			...
			<div class="content">
                    <div class="container">
                     ...
                     <div class="panel-heading">
                                 	...
                                 	<div class="row">
                                 <form action="viewCorpInteractions" method="post" class="form-inline">	
                        		<div class="panel-heading">
