                    ...
                    <div class="container">
                        ...
                        <ul class="nav navbar-nav navbar-left">
                         <li>
                            ...
                            <li>
                             <a href="corporateDashBoard?userId=<c:out value="${USERID}" />"> <i class="fa fa-home fa-2x" > </i>  </a>
                            </li>
                            <li class="hidden-xs hidden-sm">
                                <font class="page-title">CORPORATE APPOINTMENTS</font>
                            </li>
                        </ul>
			...
			<div class="content">
                    <div class="container">
                     ...
                     <div class="panel-heading">
                                 	...
                                 	<div class="row">
                                 <form action="viewcorpAppt" class="form-inline">	
                        		<div class="panel-heading">
...
<input type="text" name="toDate" value="${toDate}" id="datepicker-autoclose1"
														class="form-control input-sm" />
</div>  

<div class="form-group">
	 <label class="" for="email">Executive:</label>
<select name="executive" title="Appointment Status"
														id="assign" class="form-control input-sm">
														<option value="${employeeById.empId}" >${employeeById.empName}</option>
														<c:if test="${role ne 'Corporate Executive'}">
                                        ...
                                        <thead>
											...
											<tr>
												...
												<th>Action</th>
														 ...
														 <tbody>
											<c:forEach items="${viewCorporateAppointment}" var="corporate" varStatus="counter">
												<tr>
													...
													<td><c:out value="${corporate.appointmentDate}" /></td>
													<td><c:out value="${corporate.timeAppointment}" /></td>
													<td><c:out value="${corporate.status}" /></td>
													<td><c:out value="${corporate.executive}" /></td>
													<td><c:out value="${corporate.totalStrength}" /></td>
													<td><a
														href="editcorporateAppointment?corporateId=<c:out value='${corporate.appointmentId}'/>">
															<i class="fa fa-pencil-square-o" aria-hidden="true"></i>
													</a> <%--  <a href="submitCollection?collectionId=<c:out value='${collections.collectionId}'/>">
