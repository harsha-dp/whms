...
<!--add item  validation  -->
<script src="resources/validation/inventory/itemList.js"></script>
<!--  -->
</head>
			...
			<div class="navbar navbar-default" role="navigation">
				<div class="container">
					...
					<li>
						...
						<li class="hidden-xs hidden-sm"	><font class="page-title">ITEM LIST
		 ...
		 <div class="row">
                            <div class="col-sm-12">
                              ...
                              <table id="example" class="grid display nowrap" style="width: 100%">
                                        ...
                                        <tbody>
                                            <c:forEach items="${itemMaster}" var="master" varStatus="counter">
                                          <%--   <c:forEach items="${hospital.customerAddresses}" var="address"> --%>
                        <tr>
                        <td><c:out value="${counter.index+1}" /></td>
                        	<td class="account-name sort-value"><c:out value="${master.itemName}" /></td>
                        	<td class="account-name1 sort-value"><c:out value="${master.itemCategory}" /></td>
                       		<td class="account-name2 sort-value"><c:out value="${master.dept}"/></td>
                        	<td class="account-name3 sort-value"><c:out value="${master.pricePerUnit}"/></td> 
                        	<td>
                        	<a href="editItemId?itemId=<c:out value='${master.itemId}'/>"><p data-placement="left" data-toggle="tooltip" title="Edit"><button class="btn btn-default btn-xs"  data-target="#edit" ><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button></p></a></td>
			...
			<div class="container">
				<div class="card-box">
					<div class="row">
						...
						<form:form action="savemaster" name="form" onsubmit="return validate()" modelAttribute="itemMasterDTO">
							...
							<input type="hidden" name="itemGroup" value="-">
								...
								<div class="form-group">
									<label>Item Name <span style="color:red;">*</span> :</label>
									 <input type="text" name="itemName" id="custname" 
						...
						<div class="form-group">
									...
									<input type="text" name="itemCategory"  class="form-control input-md" placeholder="Ex. Computer accessories">
								</div>
								<div class="form-group">
									<label>Unit of Measure <span style="color:red;">*</span> :</label> 
									<select name="unitOfMeasure" class="form-control input-md" id="unit">
									...
									<font id="uniterror" style="color: red"></font>
								</div>
								 <div class="form-group">
									<label for="name">Item Price Per Unit :</label>
									 <input type="text" name="pricePerUnit"  class="form-control input-md" /><br />
								<font id="priceerror" style="color: red"></font>
								</div>
							<div class="form-group">
									<label>Department <span style="color:red;">*</span> :</label> 
									<select name="dept" class="form-control input-md" id="department">
								...
								<div class="form-group">
									<label>Description :</label>
									 <textarea type="text" name="description" 	class="form-control input-md" placeholder="write description about items"></textarea><br />
								</div>
