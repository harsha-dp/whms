...
<script src="resources/validation/inventory/outward.js"></script>
                    ...
                    <div class="container">
                        ...
                        <ul class="nav navbar-nav navbar-left">
                         <li>
                            ...
                            <li>
                             <a href="inventoryDashboard"> <i class="fa fa-home fa-2x" aria-hidden="true"> </i>  </a>
                            </li>
                            <li class="hidden-xs hidden-sm">
                               <!--  <h4 class="page-title">Edit Hospital </h4> -->
                               <font class="page-title">ADD OUTWARD </font>
                            </li>
                        </ul>
	...
	<!-- =============	form:form start from here ==============    -->	    
			       		 <form:form action="saveinward" name="form" onsubmit="return validate()"  modelAttribute="inventry">
			       		 	 <form:hidden path="actionBy" value="<%=id %>" class="form-control"  />
			       		 	 
			       			  <form:hidden path="itemId" value="${itemId}"/>           
			                 <form:hidden path="entryType" value="OutWard"/>
									...
									<div class="row">
										<div class="col-md-12">
											<div class="col-md-6">
												<div class="form-group">
													...
													<div class="input-group">
													 ...
													 <form:input
														type="text" path="" value="${itemName}" class="form-control" readonly="true" /> 
												</div>
												</div>
												</div>
											...
											<div class="col-md-6">
												<div class="form-group">
												<label>Issued Date <span style="color:red;">*</span></label><br>
												<div class="input-group"> 
												<form:input type="text" path="actionDate" class="form-control" id="datepickerautoclose" /> 
								...
								<div class="col-md-6">
									...
									<span class="input-group-addon"><i class="fa fa-building" aria-hidden="true"></i></span>
											...
											<c:forEach var="vendor" varStatus="status" items="${allVendors}">
													<form:option path="vendorId" value="${vendor.vendorId}">${vendor.vendorCompany}</form:option>
											</c:forEach>
										    </form:select>
									</div>
							...
							<div class="col-md-6">
								 <div class="form-group">
								     <label>Department List <span style="color:red">*</span></label>
								     <div class="input-group">
								<span class="input-group-addon"><i class="fa fa-list" aria-hidden="true"></i></span>
						...
						<div class="col-md-6">
								...
								<span class="input-group-addon"><i class="fa fa-user" aria-hidden="true"></i></span>
                                 	 <select name="issuedTo" class="form-control " id="sel2">
					...
					<div class="col-md-6">
							<div class="form-group">
										...
										<div class="input-group">
														<span class="input-group-addon"><i class="fa fa-user" aria-hidden="true"></i></span>
														<form:input path="" value="<%= userID %>" class="form-control" readonly="true" />
                                              ...
                                              <div class="col-md-6">
												<div class="form-group">
													...
													<div class="input-group">
													 ...
													 <form:input type="text" path="quantity" id="quantity" class="form-control" />
												</div>
