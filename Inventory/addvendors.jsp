...
<script src="resources/validation/inventory/addVendors.js"></script>
<!--  -->
<style>
tfoot {
				...
				<div class="container">
					...
					<ul class="nav navbar-nav navbar-left">
					 <li>
						...
						<li class="hidden-xs hidden-sm"	><font face="verdana"  class="page-title">VENDORS LIST </font> <!-- <h4 class="page-title">Edit Presales</h4> --></li>
					</ul>
                                ...
                                <!--  <br><br>
										<a href="#custom-modal" class="btn btn-success btn-md waves-effect waves-light"  
                                           data-animation="fadein" data-plugin="custommodal" data-overlaySpeed="200" data-overlayColor="#36404a">
                                            <i class="zmdi zmdi-plus"></i> ADD NEW VENDORS
                                        </a>
                                        <br><br> -->
...
s</td>
                                        ...
                                        <tfoot>
                                            <tr>
												...
												<th>Id</th>
                                          	 	<th class="filtername">Contact Person</th>
                                             	<th class="filtername2">Company Name</th>
                                              	<th class="filtername3">Phone</th>
                                              	<th class="filtername1">Address</th>                                                
                                                <th>Actions</th>
                                            </tr>
                                        </tfoot>

                                        <tbody>
                                            <c:forEach items="${vendors}" var="vendor" varStatus="counter">
                        <tr>
                            <td><c:out value="${counter.index+1}" /></td>
                        	<td class="account-name sort-value"><c:out value="${vendor.vendorName}"/></td>
                       		<td class="account-name2 sort-value"><c:out value="${vendor.vendorCompany}"/></td>
                       		<td class="account-name3 sort-value"><c:out value="${vendor.vendorPhone}"/></td> 
                        	<td class="account-name1 sort-value"><c:out value="${vendor.vendorAddress}"/></td>                        	
                        	
                        	<td>
                        	<a href="editVendorsId?vendorId=<c:out value='${vendor.vendorId}'/>"><p data-placement="left" data-toggle="tooltip" title="Edit"><button class="btn btn-default btn-xs"  data-target="#edit" ><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button></p></a></td>
                        </tr>
                    </c:forEach>
                                        </tbody>
                                    </table>
				...
				<div class="card-box">
					...
					<!--  <div class="modal fade none-border" id="add-category"> -->
									...
									<!-- =============	form:form start from here ==============    -->
									 <form:form action="savevendors" name="form" onsubmit="return validate()" modelAttribute="addvendors">
										<div class="row">
											<div class="col-md-12">
												<div class="form-group">
													<label>Contact Person Name <span style="color:red;">*</span></label><br> 
													<form:input type="text" path="vendorName"  id="custname"  class="form-control"  /> 
												  <font id="custnameerror" style="color: red"></font>
												</div>

<div class="form-group">
													<label for="name">Company Name <span style="color:red;">*</span></label> <form:input type="text" path="vendorCompany"  id="company"
														class="form-control" />
												<font id="companyerror" style="color: red"></font>
												</div>
												
												<div class="form-group">
													<label for="name">Specify Category  <span style="color:red;">*</span></label> <form:input type="text" path="vendorCategory" id="category"
														class="form-control" />
												<font id="caterror" style="color: red"></font>
												</div>

												

												<div class="form-group">
													<label for="name">Company/Contact Address </label><span style="color:red;">*</span> <form:textarea type="text" path="vendorAddress" id="addresss"
														class="form-control" />
												<font id="addresserror" style="color: red"></font>
												</div>

												<div class="form-group">
													<label for="name">Phone Number </label> <form:input type="text" path="vendorPhone"  
														class="form-control" />
												...
												<div class="form-group">
													<label for="name">Email Id</label> <form:input type="text" path="vendorEmail"
														class="form-control" />
												</div>


												<div class="form-group">
													<label for="name">ACC No,Bank Details,IFSC & Address</label> <form:textarea type="text" path="vendorBankDetails"
														class="form-control" />
												</div>
											</div>
										</div>
