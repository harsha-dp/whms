										...
										<div class="col-sm-12">
											<div class="scrollit">
												<table id="example" class="grid display nowrap"
													...
													<tbody>
														  <c:forEach items="${itemReport}" var="item" varStatus="counter">
										                      <tr style="display: table-row;">
										                        	<td><c:out value="${item.index+1}"/></td>
										                        	<td><c:out value="${item.itemName}"/></td>
										                        	<td><c:out value="${item.vendorCompany}"/></td>										                        	 
										                        	 <td><c:out value="${item.issuedOn}"/></td>										                        	 
										                        	 <td><c:out value="${item.issuedTo}"/></td>										                        	 
										                        	 <td><c:out value="${item.description}"/></td>
										                        	 <td><c:out value="${item.notes}"/></td>
										                        	 <td><c:out value="${item.issuedBy}"/></td>									                        	 
										                       </tr>
										                     </c:forEach>
													</tbody>
												</table>
