...
function validate(from)
{
 ...
 var error=document.getElementById("priceerror");
      ...
      if( price==null || price==""){
          error.innerHTML="Enter price !!";
          return false;
      }

     
      if(price.length>6){
          error.innerHTML="Price should be in between 3 to 6 digits";
          return false;
      }/*end */
	...
	var error=document.getElementById("uniterror");
      ...
      if( unit==null || unit==""){
          error.innerHTML="Enter quantity !!";
          return false;
      }
      ...
      if(unit.length>5){
          error.innerHTML="Quantity should be in between 1 to 5 digit";
          return false;
      }/*end */
	    ...
	    var error=document.getElementById("depterror");
		      ...
		      if(department==null || department==""){
		          error.innerHTML="Enter Department name";
		          return false;
		      }

		     
		      if(department.length>30){
		          error.innerHTML="Department name should be in between 3 to 20 character";
		          return false;
		      }
				...
				<div class="container">
					...
					<ul class="nav navbar-nav navbar-left">
						...
						<li class="hidden-xs hidden-sm">
							...
							class="page-title">EDIT ITEM </font>
						</li>
					</ul>
						...
						<div class="modal-dialog">
							<div class="modal-content">
								<div class="modal-header">
									...
									<h4 class="custom-modal-title">EDIT ITEM :</h4>
									<div class="custom-modal-text text-left">

										<!-- =============	form:form start from here ==============    -->
										<form:form action="editmastersave" name="form"
											onsubmit="return validate()" modelAttribute="itemMaster">
<form:hidden path="currentStock" value="${master.currentStock}" />
											<form:hidden path="itemId" value="${master.itemId}" />
											<%--  <form:hidden path="itemId" value="<%=id%>" class="form-control" /> --%>
											<form:input type="hidden" path="assetType" value="1" />
											<form:input type="hidden" path="itemGroup" value="-" />
											...
											<div class="col-lg-12">
												...
												<div class="form-group">
													...
													<form:input type="text" path="itemName"
														value="${master.itemName}" id="custname"
												...
												<div class="form-group">
													...
													<form:input type="text" path="itemCategory"
														value="${master.itemCategory}"
														class="form-control input-md" />
													<br />
												</div>
											...
											<%-- 	<div class="form-group">
													...
													<form:input type="text" path="pricePerUnit"
														value="${master.pricePerUnit}"
														class="form-control input-md" />
													<br /> <font id="priceerror" style="color: red"></font>
												</div> --%>

											<%-- 	<div class="form-group">
													<label for="name">Current Stock :</label>
													<form:input type="text" path="currentStock"
														value="${master.currentStock}"
														class="form-control input-md" />
													<br />
												</div> --%>
												...
												<div class="form-group">
													...
													<form:input type="text" path="unitOfMeasure"
														value="${master.unitOfMeasure}"
														class="form-control input-md" />
													<font id="uniterror" style="color: red"></font>
												</div>

												<%-- <div class="form-group">
													<label for="name">Department :<span
														style="color: red;">*</span></label>
													<form:input type="text" path="dept" value="${master.dept}"
														class="form-control input-md" />
												</div> --%>
