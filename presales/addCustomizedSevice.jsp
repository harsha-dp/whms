...
<!--add file validation  -->
<script src="resources/validation/presales/addCustomizedSevice.js"></script>
<!--  -->
</head>
		...
		<div class="topbar">
			...
			<div class="navbar navbar-default" role="navigation">
				<div class="container">
					...
					<ul class="nav navbar-nav navbar-left">
					  <li>
						...
						<font face="verdana" class="page-title">CUSTOMIZED PRODUCT</font>
              ...
              <button type="button" class="button button5" value=" Go Back !" 
									...
									<i class="userProfile?userId=53" aria-hidden="true"> </i>
								</button>
             </li>
					</ul>
				</div>
					...
					<div class="modal-dialog">
						<div class="modal-content">
							<div class="modal-header">
								...
								<h4 class="custom-modal">ADD SERVICES FOR CUSTOMIZED PRODUCT</h4>
								<div class="custom-modal-text text-left">


									<!-- =============	form:form start from here ==============    -->

                        					<form class="form-horizontal" name="form" onsubmit="return validate()" action="saveCustomizedService">
					             <div class="row">
                        				<div class="col-lg-12">
												<input type="hidden" name="collectionId" value="${collectionId}">
												<input type="hidden" name="updatedBy" value="<%=id %>"> 
	                                            <div class="form-group">
	                                                <label class="col-md-2 control-label">Enter Total Amount </label>
	                                                <div class="col-md-9">
	                                                    <input type="text" id="defaultconfig" name="amount"  class="form-control text-rounded" style="border-radius: 4px;">
	                                                    <font id=droperror style="color:red"></font>
	                                                    <span id="error" style="color: red; display: none">
												</span>
	                                                </div>
	                                            </div>
	                                             <table class="table table-responsive" bordercolor="gary" border="1">
	                                             <thead>
	                                             <tr class="bg-warning">
	                                             <th >#</th>
	                                             <th >SERVICE LIST</th>
	                                             <th >Enter Qunatity</th>
	                                             </tr>
	                                             </thead>
	                                             <tbody>
	                                             <c:forEach items="${services}" var="service" varStatus="counter">
                        							...
                        							<td><input type="hidden" name="serviceId" value="${service.serviceId}"><c:out value="${service.serviceName}"/></td>
                        							<td><input type="text" class="form-control input-sm" name="quantity" onkeypress="return IsNumeric(event);"  maxlength="2" style="border-radius: 5px;"></td>
                        							</tr>
	                                             </c:forEach>
	                                             </tbody>
	                                             </table>
	                                        <div align="center">
	                                     <input type="submit" onclick="return validate()"  class="form control btn btn-primary btn-rounded btn-md " value="SUBMIT OFFERS">
	                                    </div>
                        				</div><!-- end col -->
