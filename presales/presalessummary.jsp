			...
			<div class="navbar navbar-default" role="navigation">
				<div class="container">
					...
					<ul class="nav navbar-nav navbar-left">
						...
						<li class="hidden-xs hidden-sm"><font class="page-title">PRE-SALES
								SUMMARY</font></li>
					</ul>
					...
					<div id="myDIV">
						<div class="panel panel-default">
							<div class="panel-heading">
								<form action="presalesSummary1" method="post"
									class="form-inline">
									...
									<div class="row">
										<div class="panel-heading">
											...
											<div class="form-group">
												<label class="" for="email">Group By:</label> <select
													name="csr" title="----GroupBy Name----" id="assign"
													class="form-control input-sm">
													<option value="" label="select group by"></option>
													<option Value="CSR">CSR</option>
													<option Value="Channel">Channel</option>
													<option Value="Executive">Executive</option>
													<option Value="Date Of Appointment">Date Of
														Appointment</option>
												</select>
														...
														<c:forEach var="row" items="${stkList}">
															<tr align="center">
																...
																<c:if test="${columnName.size() >= 3}">
																	<td class="danger">${row.attr3}</td>
																</c:if>
																<c:if test="${columnName.size() >= 4}">
																	<td class="danger">${row.attr4}</td>
																</c:if>
																<c:if test="${columnName.size() >= 5}">
																	<td class="success">${row.attr5}</td>
																</c:if>
																<c:if test="${columnName.size() >= 6}">
																	<td class="success">${row.attr6}</td>
																</c:if>
																<c:if test="${columnName.size() >= 7}">
																	<td class="success">${row.attr7}</td>
																</c:if>
																<c:if test="${columnName.size() >= 8}">
																	<td class="info">${row.attr8}</td>
																</c:if>
