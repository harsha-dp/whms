                        ...
                        <ul class="nav navbar-nav navbar-left">
                         <li>
                            ...
                            <li class="hidden-xs hidden-sm">
                                <font class="page-title">APPOINTMENTS</font>
                            </li>
                        </ul>
			...
			<div class="content">
                    <div class="container">
                     ...
                     <div class="panel-heading">
                                 	<div class="row">
                                   <form:form action="searchAppointment2"  modelAttribute="presales" 
class="form-inline">		
                        		<div class="panel-heading">
...
<form:input type="text" path="dateAppointment" value="${fromDate}" id="datepicker-autoclose" class="form-control input-sm"  />
</div>	

<div class="form-group">
	 <label class="" for="email">To:</label>
<form:input type="text" path="timeAppointment" value="${toDate}" id="datepicker-autoclose1" class="form-control input-sm"  />
</div>	

<div class="form-group">
	 <label class="" for="email">Status:</label>
<form:select path="status" title="----Status----"  id="assign" class="form-control input-sm">
																<form:option value="" label="select Appointment status" ></form:option>
																<form:option path="status" value="Rescheduled">Rescheduled</form:option>
																<form:option path="status" value="Collected">Collected</form:option>
																<form:option path="status" value="New Appointment" >New Appointment</form:option>
																</form:select>
</div>
<div class="form-group">
	 <label class="" for="email">Appt Type:</label>
<form:select path="meetingStatus" title="----Appointment Type----"  id="assign" class="form-control input-sm">
																<form:option value="" label="select Appointment status" ></form:option>
																<form:option path="meetingStatus" value="Fresh">Fresh</form:option>
																<form:option path="meetingStatus" value="FollowUp">FollowUp</form:option>
...
<div class="form-group">
	 <label class="" for="email">CSR:</label>
<form:select path="applicationNo" title="----Csr Name----" id="assign" class="form-control input-sm">
																<form:option  value="" label="select CSR name" ></form:option>
																<c:forEach var="employee" varStatus="status" items="${csr}">
																<form:option path="applicationNo" value="${employee.empId}" >${employee.empName}</form:option>
																</c:forEach>
																</form:select>
</div>											
<div class="form-group">
	 <label class="" for="email">Executive:</label>
<form:select path="city" title="----Select Executive----"	id="assign" class="form-control input-sm">
																<form:option value="" label="select executive name" />
																<c:forEach var="employee1" varStatus="status" items="${executive}">
																<form:option path="city" value="${employee1.empId}" >${employee1.empName}</form:option>
																</c:forEach>
																</form:select>
</div>
							                	...
							                	<tr style="display: table-row;">
							                       <%--  <td class="account-id"><a class="sort-value" href="user/1" target="_blank"><c:out value="${presales.leadsId}" /></a></td> --%>
							                        ...
							                        <%--  <td class="account-name1 sort-value"><c:out value="${presales.address.primaryMob}" /></td> --%>
							                          <td><c:out value="${presales.primaryMob}" /></td>
							                            <td><c:out value="${presales.productName}" /></td>
							                           <td><c:out value="${presales.channelsName}" /></td>
							                           <td><c:out value="${presales.csrName}" /></td>
							                           ...
							                           <td><c:out value="${presales.executiveName}" /></td>
