                        ...
                        <ul class="nav navbar-nav navbar-left">
                         <li>
                            ...
                            <li class="hidden-xs hidden-sm"	>
                                <font class="page-title">WALK IN CUSTOMER LIST</font>
                            </li>
                        </ul>
			...
			<div class="content">
                    ...
                    <div class="container">
                     ...
                     <div class="panel-heading">
                                 	...
                                 	<div class="row">
                                  <form action="walkInCustomers1" class="form-inline">		
                        		<div class="panel-heading">
                                 		<div class="col-sm-12">
...
<div class="form-group">
 ...
 <table id="example" class="grid display nowrap" style="width: 100%">
                                        ...
                                        <tbody>
                                <c:forEach var="list" items="${walkinCustomer}" varStatus="counter"> 
                                <form action="saveWalkInCustomer"> 
                             ...
                             <td><c:out value="${counter.index + 1}" /></td>
                              <td><c:out value="${list.walkinCustomerName}"></c:out></td>
                               <td><c:out value="${list.walkinCustomerMsg}"></c:out></td>
                             <td><c:out value="${list.datetime}"></c:out></td>
                             <td><c:out value="${list.phone}"></c:out></td>
                             <td><c:out value="${list.email}"></c:out></td>
                              <td>
                              <c:if test="${list.status ne null}"><c:out value="${list.status}"></c:out></c:if>
                              ...
                              <option value="Call Back">Call Back</option>
                                 ...
                                 <td>
                                 <c:if test="${list.remarks ne null}"><c:out value="${list.remarks}"></c:out></c:if>
                              	<c:if test="${list.remarks == null}">
                                 <textarea name="remarks" ></textarea> </c:if></td>
                             <%-- <td><a href="editWalkInCustomer?id=<c:out value='${list.id}' /> " >Submit</a></td> --%>
                           <td> <c:if test="${list.status == null}">  <button class="btn btn-primary btn-xs"  data-target="#edit"  >Submit</button></c:if></td>
            </tr>
                             </form>
            </c:forEach>
                                        </tbody>
