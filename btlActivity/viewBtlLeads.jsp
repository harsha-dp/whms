			...
			<div class="navbar navbar-default" role="navigation">
				<div class="container">
					...
					<ul class="nav navbar-nav navbar-left">
						...
						<li><a href="salesDashboards"> <i
								class="fa fa-home fa-2x"> </i>
						</a></li>
						<li class="hidden-xs hidden-sm"><font class="page-title">BTL
								ACTIVITY </font></li>
					</ul>
										...
										<div class="col-sm-12">
											...
											<div>
												<button class="btn btn-default waves-effect waves-light"
													...
													<i class="zmdi zmdi-plus"></i> Add Leads
												</button>
											...
											<div class="scrollit">
												<table id="example" class="grid display nowrap"
													...
													<tbody>
														<c:forEach items="${allBTlLeads}" var="btl"
															varStatus="counter">

															<tr>
																<td><c:out value="${counter.index + 1}" /></td>
																<td><c:out value="${btl.leaName}" /></td>
																<td><c:out value="${btl.contactNumber}" /></td>
																<td><c:out value="${btl.age}" />/<c:out
																		value="${btl.gender}" /></td>
																<td><c:out value="${btl.bp}" /></td>
																<td><c:out value="${btl.sugar}" /></td>
																<td><c:out value="${btl.parkName}" /></td>
															</tr>


															<%--   <form action="updatesBTlLeads">
                        <tr>
							
							<td><input type="hidden" name="btlId" value="${btl.btlId}"><c:out value="${counter.index + 1}"/></td>
                        	 <td><c:out value="${btl.leaName}"/></td> 
                        	 <td><c:out value="${btl.contactNumber}"/></td>
                        	 <td><c:out value="${btl.age}"/></td>
                        	 <td><select name="leadStatus" style="width:170px;height: 26px">
                        	 <option value="${btl.leadStatus}">${btl.leadStatus}</option>
						...
						<div class="modal-content">
							<div class="n" id="n">
								...
								<div class="modal-body">
									<form action="saveBTLLeads" name="form2"
										...
										<div class="form-group">
											<label class="" for="email">Executive Name:</label> <input
												type="text" name="executive" class="form-control input-sm"
												id="executive"
												onkeypress="return onlyAlphabets(event,this);" />
										</div>
										<div class="form-group">
											<label class="" for="email">Park Name:</label> <select
												name="parkId" class="form-control input-sm" id="parkn">
										...
										<div class="table-responsive">
											<TABLE id="dataTable" width="1250px" border="1">
												<TR>
