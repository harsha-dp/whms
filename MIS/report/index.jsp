          ...
          <div class="col-md-12 nav-wrapper">
            <div class="navbar-header" style="width:100%;">
              ...
              <ul class="nav navbar-nav navbar-right user-nav">
                <li class="user-name"><span>Employee Name</span></li>
                  <li class="dropdown avatar-dropdown">
                   <img src="resources/reportMIS/asset/img/avatar.jpg" class="img-circle avatar" alt="user name" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true"/>
              ...
              <div class="sub-left-menu scroll">
                <ul class="nav nav-list">
                    ...
                    <li class="active ripple">
                      <a class="tree-toggle nav-header"><span class="fa fa-home"></span> Dashboard 
                   ...
                   <!--  <div class="col-md-12"> -->
                        <div class="form-group">
			                                	     <div class="col-sm-8 col-md-8 col-lg-8" >
														...
														<span class="input-group-addon bg-primary b-0 text-white">Collected From</span>
														<input type="text" id="datepicker-autoclose" class="form-control input-sm"  /> 
														<span class="input-group-addon bg-primary b-0 text-white">To</span>
														<input type="text" id="datepicker-autoclose1" class="form-control input-sm"  /> 
													    </div>
													</div>
													
													<div class="col-sm-4 col-md-4 col-lg-4">
															<button type="submit" class="btn btn-round btn-info btn-sm" value="Go"><i class="fa fa-search" aria-hidden="true"></i> Search</button>
			                                	   </div>
