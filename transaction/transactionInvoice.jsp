                    ...
                    <div class="container">
                        ...
                        <ul class="nav navbar-nav navbar-left">
                         <li>
                            ...
                            <li>
                            <font class="page-title">CUSTOMER INVOICE </font>
                            </li>
                        </ul>
                 ...
                 <table cellpadding="0" cellspacing="0" width="100%" style="border: 2px;" rules="none" >
                                                ...
                                                <tr >
													...
													<tr>
                                                        ...
                                                        <td colspan="1"><br> <p style="line-height:0"><strong>${invoiceTransactionDetails.customerName}</strong>  </p> 
                                                        <address>
                                                        <p style="line-height:0.5; font-family: Times New Roman">${address.residenceAddresss}</p>
                                                      <!--   <p style="line-height:0.5">14th mail, 6th sector HSR Layout,</p> -->
                                                        <p style="line-height:0.5">${address.city}-${address.pincode}</p>
                                                        <p style="line-height:0.5">Contact No : ${address.primaryMob}</p>
                                                        </address>
                                                        </td>
                                                    <td>
                                                    
                                                     <table class="table table-bordered">
                                                    <tr><td  style=" vertical-align : middle;"> <p style="line-height:0.5"><strong>Invoice No .</strong> :${invoiceTransactionDetails.applicationNo}</p></td></tr>
                                                   ...
                                                   <td><p style="line-height:0.5"><strong>Service</strong>: FEB-MAR 2018</p></td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><strong> Date</strong> : ${invoiceTransactionDetails.collectedDate}</td>
                                                    ...
                                                    <tr>
                                                    <td>${invoiceTransactionDetails.productName}</td></tr>
                                                     <tr height="150">
                                                       <td>
                                                       <table class="table table-bordered" >
                                                       <tr>
                                                      ...
                                                      <th>Services</th>
                                                       ...
                                                       <c:forEach items="${servicesBasedOnProductId}" var="list" varStatus="counter">
                                                       <tr>
                                      ...
                                      <table cellpadding="0" cellspacing="0" width="100%" style="border: 1px;" rules="none">
                                                    ...
                                                    <td class="text-center">${invoiceTransactionDetails.amount}</td>
                                                    <td align="right">${invoiceTransactionDetails.amount}</td>
                                                    </tr>
                                                     ...
                                                     <tr>
                                                        ...
                                                        <p style="line-height:0.5"><strong><q>Welezo Healthcare Private Limited</q> by Cheque payabale</strong></p>
                                                         </td>
                                                        <td> 
                                                    ...
                                                    <td align="right"><strong> <p style="line-height:0.5">${invoiceTransactionDetails.amount}</p></strong></td>
                                                    </tr>
                                                    </table>
                                                    
                                                    <table class="table table-bordered">
                                                    <tr><td colspan="2" align="center"> <p style="line-height:0.5"><strong><b id="demo"></b></strong></p></td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <p style="line-height:0.6;"><u>Note : All Bank charges and commissions / expenses to your account.</u></p>
...
<script type="text/javascript">
      ...
      <script type="text/javascript">
     var sal =  ${invoiceTransactionDetails.amount};
