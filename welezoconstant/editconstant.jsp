				...
				<div class="container">
					...
					<ul class="nav navbar-nav navbar-left">
					  <li>
						...
						<li class="hidden-xs hidden-sm"	><font face="verdana" class="page-title">Constatnt
			...
			<br>
				<div class="card-box">
					<div class="row">
								...
								<form:form class="form-horizontal" action="saveconstant" modelAttribute="welezoConstantsTO">
                                     
                                       <%--  <form:hidden path="id" value="${welezo.id}"/>
			                            <form:hidden path="id" value="<%=id%>" class="form-control" /> --%>
			        	           
			        	           <div class="row">
			        	           <div class="col-md-4">
			        	            <label>Category</label>
			        	          <%--  <form:select path="id" title="----category----"
											class="form-control">
											<form:option value="" label="select company Name" />
											<c:forEach var="welezo" varStatus="status" items="${allcategory}" >
													<form:option path="id" value="${welezo.id}">${welezo.constType}</form:option>
											</c:forEach>
										</form:select>  --%>
			        	          <form:input type="text" path="constType" class="form-control" value="${welezo.constType}" />
			        	           </div>
                                
                                     
                                      <div class="col-md-4">
                                     <label>C value</label>
                                       <form:input type="text" path="CValue" class="form-control" value="${welezo.CValue}" />
                                     </div>
                                   
                                       <div class="col-md-4">
                                        <label>D value</label>
                                       <form:input type="text" path="CDisplay" class="form-control" value="${welezo.CDisplay}" />
                                   </div>
                                   </div>
                                   </form:form>
                                   </div>
