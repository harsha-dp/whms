...
<!--add file validation  -->
<script src="resources/validation/welezoconstant/goalSettings.js"></script>
<!--  -->
				...
				<div class="container">
					...
					<ul class="nav navbar-nav navbar-left">
					 <li>
						...
						<li class="hidden-xs hidden-sm"	><font face="verdana" class="page-title">GOAL SETTING
	...
	<div class="content-page">
		...
		<div class="content">
			...
			<br>
				<div class="card-box">
					<div class="row">
					<form action="savegoal" name="form" onsubmit="return validate()" >
						<div class="card-box card-outline-danger">
						<h4 class="header-title m-t-0 m-b-30">SET EMPLOYEE GOALS :</h4>
							<div class="col-md-12">
								<div class="col-md-6">
									<label for="ex1">Plan Title <span style="color:red">*</span></label>
									<input type="text" name="goalName" class="form-control" placeholder=" "
										id="goalname" />
					    	...
					    	<div class="col-md-3">
							     <div class="form-group">
								    <label>Metric<span style="color:red">*</span></label>
							...
							<div class="col-lg-12">
							            <div class="col-xs-3">
											...
											<select name="metricType" class="form-control" title="Select" id="Appraisal">
										...
										<div class="col-md-3">
											...
											<div class="input-group">
												<input type="text" name="goalFrom" class="form-control"
										...
										<div class="col-md-3">
											...
											<div class="input-group">
												<input type="text" name="goalTo" class="form-control"
									...
									<div class="col-lg-12">
											<div class="col-xs-9">
												...
												<input name="goalInfo" class="form-control" id="goal"
									...
									<div class="col-lg-12">
											<div class="col-xs-9">
												<label for="ex1">Target</label>
												<input name="target" class="form-control" id="ex3"
													placeholder="">
											</div>
									</div>
									<p>&nbsp;</p>
