...
<!--add file validation  -->
<script src="resources/validation/welezoconstant/selfEvaluation.js"></script>
<!--  -->
</head>
			...
			<br>
				<div class="col-sm-12">
					<div class="card-box table-responsive">
						<h3 align="center"
							style="mergin: 4px; background-color: #6f809b; color: white;">EMPLOYEE
							SELF EVALUATION.</h3>

						<form:form action="savePerfromance" name="form"
							onsubmit="return validate()" modelAttribute="performanceDTO">
							<form:hidden path="module" value="Admin" />
							<div class="card-box card-outline-danger">
								<div class="form-group">
									<div class="row">
										...
										<div class="col-xs-3">
											...
											<form:select class="form-control" path="evaluatorPeriod"
												title="Select" id="period">
												<form:option value="" label="Select evaluation period" />
												<form:option path="evaluatorPeriod" value="January 2017">January 2017</form:option>
												<form:option path="evaluatorPeriod" value="February 2017">February 2017</form:option>
												<form:option path="evaluatorPeriod" value="March 2017">March 2017</form:option>
												<form:option path="evaluatorPeriod" value="April 2017">April 2017</form:option>
												<form:option path="evaluatorPeriod" value="May 2017">May 2017</form:option>
												<form:option path="evaluatorPeriod" value="June 2017">June 2017</form:option>
												<form:option path="evaluatorPeriod" value="July 2017">July 2017</form:option>
												<form:option path="evaluatorPeriod" value="August 2017">August 2017</form:option>
												<form:option path="evaluatorPeriod" value="September 2017">September 2017</form:option>
												<form:option path="evaluatorPeriod" value="October 2017">October 2017</form:option>
												<form:option path="evaluatorPeriod" value="November 2017">November 2017</form:option>
												<form:option path="evaluatorPeriod" value="December 2017">December 2017</form:option>
											</form:select>
									...
									<div class="row">
										...
										<div class="col-md-6">
											<table class="table table-striped table-bordered">
												<thead>
													<tr>
														<th>Sl No</th>
														<th style="background-color: lightblue;">Dimension</th>
														<th align="center" style="background-color: lightblue;">rate
															yourself on a scale of 1 to 5(Note: 1 is low 5 is high)</th>
													</tr>
												</thead>
												<tbody>
													<c:forEach items="${allMetricsHR}" var="metric">
														<tr>
															<td><form:hidden path="metricId"
																	value="${metric.metricId}" />
																<c:out value='${metric.metricId}' /></td>
															<td><c:out value="${metric.mNname}" /></td>
															<td align="center"><c:if
																	test="${metric.ratingType == 'Discrete'}">
																	<c:set var="ratingOptions"
																		value="${metric.ratingOptions}" />
																	<c:set var="rating"
										...
										<c:forEach items="${allMetricsManager}" var="metric">
											<tr>
												<td><form:hidden path="metricId"
														value="${metric.metricId}" /></td>
												<td><form:hidden path="text" value="-" /></td>
											</tr>
										</c:forEach>
									</div>
								</div>
								...
								<div align="center">
									<button type="submit" onclick="return validate()"
										class="btn btn-primary btn-rounded w-lg waves-effect waves-light">Submit</button>
								</div>
							</div>
						</form:form>
					</div>
