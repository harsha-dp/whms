...
<!--add file validation  -->
<script src="resources/validation/welezoconstant/editLeaves.js"></script>
<!--  -->
</head>
									...
									<div class="modal-header">
										...
										<div class="custom-modal-text text-left">
											...
											<!-- =============	form:form start from here ==============    -->
											 ...
											 <form:form  action="postEditleavesAdmin" name="form" onsubmit="return validate()" modelAttribute="leaveRequest" > 
							 <form:hidden path="requestId" value="${leavesById.requestId}"/>
												<form:hidden path="approvedBy" value="<%=id%>" />
												<div class="row">
													<div class="col-md-12">
														<div class="col-md-7">
														...
														<div class="col-md-5">
															...
															<form:input type="number" path="totalDays"
