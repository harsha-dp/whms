...
<!--add file validation  -->
<script src="resources/validation/welezoconstant/viewLeaves.js"></script>
<!--  -->
				<style>
tfoot {
                          ...
                          <li>
                            ...
                            <li class="hidden-xs hidden-sm"	>
                             <!--    <h4 class="page-title">View Hospitals </h4> -->
                                <font face="verdana"  class="page-title">VIEW LEAVES LIST</font>
                            </li>
                        </ul>
...
<br>
                        ...
                        <td><c:out value="${counter.index + 1}" /></td>
                        	...
                        	<c:if test="${leaves.status == 'New' ||leaves.status == 'Requested' }">
                        	 	<td><a href="editLeaveslist?requestId=<c:out value='${leaves.requestId}'/>" >
                        	 	<button type="button" class="btn btn-warning btn-xs" >Edit</button></a></td> </c:if>
