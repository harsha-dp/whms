                        ...
                        <ul class="nav navbar-nav navbar-left">
                          <li>
                            ...
                            <li class="hidden-xs hidden-sm"	>
                             <font face="verdana" class="page-title">VIEW PENDING SUBMISSION</font>
                ...
                <div class="content">
                    <div class="container">
                          <div class="card-box table-responsive">
											...
											<tbody>
                                            <c:forEach items="${allCollections}" var="collections" varStatus="counter">
                                             
                        <tr>
                        <td><c:out value="${counter.index+1}"/></td>
                        	 <td><c:out value="${collections.customerName}"/></td>
                        	 <td><c:out value="${collections.productName}"/></td>
                        	 <td><c:out value="${collections.productPrice}"/></td>
                        	 <td><c:out value="${collections.paymentMode}"/></td> 
                        	 <td><c:out value="${collections.csr}"/></td> 
                        	 <td><c:out value="${collections.channelName}"/></td> 
                        	 <td><c:out value="${collections.executive}"/></td> 
                        	 <td><c:out value="${collections.colectedDate}"/></td>
                        	<%--  <td><c:out value="${collections.collectedBy}"/></td>   --%>
                        	<td>
                      
                       <a href="submitCollection?collectionId=<c:out value='${collections.collectionId}'/>">
