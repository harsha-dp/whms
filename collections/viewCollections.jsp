                        ...
                        <ul class="nav navbar-nav navbar-left">
                         <li>
                            ...
                            <li class="hidden-xs hidden-sm"	>
                                <font class="page-title">VIEW COLLECTIONS</font>
                            </li>
                        </ul>
			...
			<div class="content">
                    ...
                    <div class="container">
                     ...
                     <div class="panel-heading">
                                 	...
                                 	<div class="row">
                                   <form action="viewCollections" class="form-inline">			
                        		<div class="panel-heading">
...
<select name="csr" title="----Csr Name----" id="assign" class="form-control input-sm">
																<option  value="" label="select CSR name" ></option>
 ...
 <table id="example" class="grid display nowrap" style="width: 100%">
                                        <thead>
											...
											<th>Action</th>
														 ...
														 <tbody>
                                            <c:forEach items="${allCollections}" var="collections" >
                      <tr style="display: table-row;">
                        	<td><c:out value="${collections.applicationNo}"/></td>
                        	 <td><c:out value="${collections.customerName}"/></td>
                        	 <td><c:out value="${collections.productName}"/></td>
                        	 <td><c:out value="${collections.price}"/></td>
                        	 <td><c:out value="${collections.paymentMode}"/></td> 
                        	 <td><c:out value="${collections.CSRName}"/></td> 
                        	 <td><c:out value="${collections.channelsName}"/></td> 
                        	 <td><c:out value="${collections.Executives}"/></td> 
                        	 <td><c:out value="${collections.colectedDate}"/></td>
                        	<td>
                        	<c:if test="${collections.transactionId == null}">
                        	<a href="editCollection?collectionId=<c:out value='${collections.collectionId}'/>">
