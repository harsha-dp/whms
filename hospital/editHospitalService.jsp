                        ...
                        <ul class="nav navbar-nav navbar-left">
                          <li>
                            ...
                            <li class="hidden-xs hidden-sm">
                               ...
                               <font class="page-title">HOSPITAL SERVICE </font>
                            </li>
                        </ul>
...
<br>
			  ...
			  <!--   <h4 class="custom-modal-title">Edit Hospital</h4> -->
			    <div class="custom-modal-text text-left">
			    
	<!-- =============	form:form start from here ==============    -->	    
			        <form action="postEditHospitalService" method="post" >
			        
			        <input type="hidden" name="hospitalId" value="${hospitalServices.hospitalId}"/>
			        <input type="hidden" name="id" value="${hospitalServices.id}" />
			        	<div class="form-group">
                           <label>Service Name</label>
                            <input type="text"   value="${hospitalServices.serviceName}" class="form-control"  readonly="true" />
                        </div>
                        <div class="form-group">
                           <label>Service Category</label>
                            <input type="text"  value="${hospitalServices.category}" class="form-control"  readonly="true" />
                        </div>
                     ...
                     <div class="col-md-11" >
							<div class="form-group">
													<div class="input-daterange input-group" id="date-range">
														...
														<span class="input-group-addon bg-default b-0 text-black">Start Date</span>
														<input type="text" name="startDate" value="${startDate}" id="date-range" class="form-control"  />
														 <span	class="input-group-addon bg-default b-0 text-black">End Date</span>
