        ...
        <div id="wrapper">
           ...
           <%--  <%@ include file="/jsp/sildermenu.jsp" %> --%>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12" >
                                            <ul class="nav nav-tabs nav-justified">
                                                ...
                                                <li role="presentation">
                                                    <a href="#profile" role="tab" id="profile-tab1" data-toggle="tab" style="font-size:1vw !important" >APPOINTMENT INPROGRESS</a>
                                                </li>
                                                <li role="presentation">
                                                    <a href="#profile2" role="tab" id="profile-tab2" data-toggle="tab" >SERVICE SUMMARY</a>
                                                </li>
                                                <li role="presentation">
                                                    <a href="#profile3" role="tab" id="profile-tab3" data-toggle="tab" >DOCUMENTS</a>
                                                </li>
                                            </ul>
                                            
                                            <div class="tab-content">
                                                <div role="tabpanel" class="tab-pane fade in active"  id="home" aria-labelledby="home"> 
                                           ...
                                           data-animation="fadein" data-plugin="custommodal" data-overlaySpeed="200" data-overlayColor="#36404a">
                                            <u>ADD NEW SERVICES</u>
                        							...
                        							<td><c:out value="${service.serviceCategory}"/></td>
                        							<td><c:out value="${service.serviceStartDate}"/></td>
                        							<td><c:out value="${service.serviceEndDate}"/></td>
                        							<td><a href="editHospitalService?id=<c:out value='${service.id}'/>"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a></td>
                        							</tr>
                    								</c:forEach>
                                        			</tbody>
                                       				</table>
			...
			<div id="custom-modal-tab" class="modal-demo">
			    ...
			    <h4 class="custom-modal-title">ADD AVAILABLE SERVICE LIST IN HEALTH CENTER </h4>
			    <div class="custom-modal-text text-left">
			<div class="container">
				<div class="card-box">
					<div class="row">
                                  <div class="form-group">
                                   <form action="saveHospitalService"   method="post"> 
                                   <input type="hidden" name="hospitalId" value="${hospitalById.hospitalId}"> 
                                   <input type="hidden" name="empanelledDate" value="${hospitalById.empanelledDate}"> 
							<div class="table-responsive">
							<table id="example" class="table table-bordered" border="2"  >
							<thead >
							<tr>
						  ...
						  <c:forEach items="${allservice}" var="service"  varStatus="counter">
							<tr>
							<td><input type="checkbox" name="serviceId" value="${service.serviceId}" /></td>
                                                ...
                                                <div role="tabpanel" class="tab-pane fade" id="profile2"
                                                 ...
                                                 <div class="row">
                        							...
                        							<td><c:out value="${hospialSummary.empanelledDate}"/></td>
                                                      ...
                                                      <!-- -------------------------Start Documnet upload -------------------------- -->
                                                      <div role="tabpanel" class="tab-pane fade"  id="profile3" aria-labelledby="profile3"> 
                                                      <div class="form-horizontal" role="form">
                                                     <form method="post" name="form" onsubmit="return validate()" action="hospitalDocument" enctype="multipart/form-data">
                      <input type="hidden" name="hospitalId" value="${hospitalById.hospitalId}" >
            <table>
             <style>
             td, th {
